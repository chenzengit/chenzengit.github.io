...
function (e, t) {
	...
	d.extend = d.fn.extend = function () {
		...
		a++), "object" == typeof s || d.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++) if (null != (e = arguments[a])) for (t in e) n = s[t],
		s !== (r = e[t]) && (l && r && (d.isPlainObject(r) || (i = d.isArray(r))) ? (i ? (i = !1, o = n && d.isArray(n) ? n: []) : o = n && d.isPlainObject(n) ? n: {},
	...
	d.extend({
		...
		proxy: function (e, t) {
			...
			d.isFunction(e) ? (i = r.call(arguments, 2), (o = function () {
	...
	var x = function (e) {
		...
		function ie(e, t, r, i) {
			...
			if (g && !i) {
				if (o = Z.exec(e)) if (l = o[1]) {
					if (9 === c) {
						if (! (a = t.getElementById(l)) || !a.parentNode) return r;
						if (a.id === l) return r.push(a),
						r
					} else if (t.ownerDocument && (a = t.ownerDocument.getElementById(l)) && x(t, a) && a.id === l) return r.push(a),
					r
				} else {
					if (o[2]) return O.apply(r, t.getElementsByTagName(e)),
					r;
					if ((l = o[3]) && n.getElementsByClassName && t.getElementsByClassName) return O.apply(r, t.getElementsByClassName(l)),
					r
				}
				if (n.qsa && (!m || !m.test(e))) {
		...
		p = ie.setDocument = function (e) {
			...
			v = [], m = [], (n.qsa = K.test(i.querySelectorAll)) && (ae(function (e) {
				...
				y.call(e, "[s!='']:x"),
				v.push("!=", I)
			}), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), t = K.test(h.compareDocumentPosition), x = t || K.test(h.contains) ?
			function (e, t) {
					...
					function (e) {
						...
						if (m) {
							...
							if (h = [s ? m.firstChild: m.lastChild], s && y) {
								for (d = (l = (c = m[b] || (m[b] = {}))[e] || [])[0] === T && l[1], p = l[0] === T && l[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();) if (1 === f.nodeType && ++p && f === t) {
									c[e] = [T, d, p];
									break
								}
		...
		function xe(e, t, n, r, i, o) {
			...
			se(function (o, s, a, u) {
				...
				} else v = ye(v === s ? v.splice(h, v.length) : v),
		...
		function be(e) {
			...
			}]; o > u; u++) if (n = r.relative[e[u].type]) p = [me(ve(p), n)];
			else {
		...
		u = ie.select = function (e, t, i, o) {
			...
			if (i = i || [], 1 === h.length) {
				...
				for (u = G.needsContext.test(e) ? 0 : l.length; u--&&(c = l[u], !r.relative[f = c.type]);) if ((p = r.find[f]) && (o = p(c.matches[0].replace(ne, re), ee.test(l[0].type) && de(t.parentNode) || t))) {
					if (l.splice(u, 1), !(e = o.length && ge(l))) return O.apply(i, o),
					i;
					break
				}
			}
	...
	(d.fn.init = function (e, t) {
		...
		if ("string" == typeof e) {
			...
			if (n[1]) {
				if (t = t instanceof d ? t[0] : t, d.merge(this, d.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t: f, !0)), w.test(n[1]) && d.isPlainObject(t)) for (n in t) d.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
				return this
			}
			return (r = f.getElementById(n[2])) && r.parentNode && (this.length = 1, this[0] = r),
			this.context = f,
			this.selector = e,
			this
		}
	...
	d.fn.extend({
		...
		closest: function (e, t) {
			for (var n, r = 0, i = this.length, o = [], s = b.test(e) || "string" != typeof e ? d(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && d.find.matchesSelector(n, e))) {
				o.push(n);
				break
			}
	...
	d.Callbacks = function (e) {
		...
		e)).once && [],
		l = function (f) {
			for (t = e.memory && f, n = !0, s = i || 0, i = 0, o = a.length, r = !0; a && o > s; s++) if (!1 === a[s].apply(f[0], f[1]) && e.stopOnFalse) {
				t = !1;
				break
			}
			r = !1,
		...
		c = {
			...
			remove: function () {
				return a && d.each(arguments, function (e, t) {
					for (var n;
					(n = d.inArray(t, a, n)) > -1;) a.splice(n, 1),
					r && (o >= n && o--, s >= n && s--)
				}),
				this
			},
	...
	d.extend({
		...
		ready: function (e) { (!0 === e ? --d.readyWait: d.isReady) || (d.isReady = !0, !0 !== e && --d.readyWait > 0 || (D.resolveWith(f, [d]), d.fn.triggerHandler && (d(f).triggerHandler("ready"), d(f).off("ready"))))
		}
	}),
	d.ready.promise = function (t) {
		return D || (D = d.Deferred(), "complete" === f.readyState ? setTimeout(d.ready) : (f.addEventListener("DOMContentLoaded", q, !1), e.addEventListener("load", q, !1))),
		D.promise(t)
	},
	d.ready.promise();
	...
	O.prototype = {
		...
		remove: function (e, t) {
			...
			if (void 0 === t) this.cache[o] = {};
				...
				d.isArray(t) ? r = t.concat(t.map(d.camelCase)) : (i = d.camelCase(t), t in s ? r = [t, i] : r = (r = i) in s ? [r] : r.match(A) || []),
				n = r.length;
				for (; n--;) delete s[r[n]]
			}
		},
	...
	d.event = {
		...
		add: function (e, t, n, r, i) {
			...
			}), l = (t = (t || "").match(A) || [""]).length; l--;) h = m = (a = Y.exec(t[l]) || [])[1],
			g = (a[2] || "").split(".").sort(),
			h && (f = d.event.special[h] || {},
			h = (i ? f.delegateType: f.bindType) || h, f = d.event.special[h] || {},
			c = d.extend({
				type: h,
				origType: m,
				data: r,
		...
		remove: function (e, t, n, r, i) {
			...
			if (v && (u = v.events)) {
				for (l = (t = (t || "").match(A) || [""]).length; l--;) if (h = m = (a = Y.exec(t[l]) || [])[1], g = (a[2] || "").split(".").sort(), h) {
					for (f = d.event.special[h] || {},
					p = u[h = (r ? f.delegateType: f.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o],
		...
		trigger: function (t, n, r, i) {
			...
			i || !h.trigger || !1 !== h.trigger.apply(r, n))) {
				if (!i && !h.noBubble && !d.isWindow(r)) {
					for (u = h.delegateType || m, V.test(u + m) || (s = s.parentNode); s; s = s.parentNode) g.push(s),
					a = s;
					a === (r.ownerDocument || f) && g.push(a.defaultView || a.parentWindow || e)
				}
				for (o = 0;
				(s = g[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u: h.bindType || m,
				(p = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) && p.apply(s, n),
				(p = c && s[c]) && p.apply && d.acceptData(s) && (t.result = p.apply(s, n), !1 === t.result && t.preventDefault());
				return t.type = m,
				i || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(g.pop(), n) || !d.acceptData(r) || c && d.isFunction(r[m]) && !d.isWindow(r) && ((a = r[c]) && (r[c] = null), d.event.triggered = m, r[m](), d.event.triggered = void 0, a && (r[c] = a)),
				t.result
			}
		},
		dispatch: function (e) {
		...
		handlers: function (e, t) {
			...
			if (a && u.nodeType && (!e.button || "click" !== e.type)) for (; u !== this; u = u.parentNode || this) if (!0 !== u.disabled || "click" !== e.type) {
				for (r = [], n = 0; a > n; n++) void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? d(i, this).index(u) >= 0 : d.find(i, this, null, [u]).length),
				r[i] && r.push(o);
				r.length && s.push({
					elem: u,
					handlers: r
		...
		mouseHooks: {
			...
			filter: function (e, t) {
				...
				return null == e.pageX && null != t.clientX && (r = (n = e.target.ownerDocument || f).documentElement, i = n.body, e.pageX = t.clientX + (r && r.scrollLeft || i && i.scrollLeft || 0) - (r && r.clientLeft || i && i.clientLeft || 0), e.pageY = t.clientY + (r && r.scrollTop || i && i.scrollTop || 0) - (r && r.clientTop || i && i.clientTop || 0)),
	...
	function (e, t) {
		d.event.special[e] = {
			...
			handle: function (e) {
				...
				i = e.handleObj;
				return (!r || r !== this && !d.contains(this, r)) && (e.type = i.origType, n = i.handler.apply(this, arguments), e.type = t),
				n
			}
		}
	}),
	...
	function fe(e, t) {
		var n, r, i, o, s, a, u, l;
		if (1 === t.nodeType) {
			if (F.hasData(e) && (o = F.access(e), s = F.set(t, o), l = o.events)) for (i in delete s.handle, s.events = {},
			l) for (n = 0, r = l[i].length; r > n; n++) d.event.add(t, i, l[i][n]);
			P.hasData(e) && (a = P.access(e), u = d.extend({},
			a), P.set(t, u))
		}
	}
	function pe(e, t) {
	...
	d.extend({
		...
		buildFragment: function (e, t, n, r) {
			for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, h = e.length; h > p; p++) if ((i = e[p]) || 0 === i) if ("object" === d.type(i)) d.merge(f, i.nodeType ? [i] : i);
			else if (ee.test(i)) {
	...
	d.fn.extend({
		text: function (e) {
			return H(this, function (e) {
				return void 0 === e ? d.text(this) : this.empty().each(function () { (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) && (this.textContent = e)
				})
			},
		...
		remove: function (e, t) {
			for (var n, r = e ? d.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || d.cleanData(pe(n)),
			n.parentNode && (t && d.contains(n.ownerDocument, n) && ce(pe(n, "script")), n.parentNode.removeChild(n));
			return this
		},
		empty: function () {
		...
		domManip: function (e, t) {
			...
			if (f && (r = (n = d.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === n.childNodes.length && (n = r), r)) {
				for (s = (o = d.map(pe(n, "script"), ue)).length; f > l; l++) a = n,
				l !== h && (a = d.clone(a, !0, !0), s && d.merge(o, pe(a, "script"))),
				t.call(this[l], a, l);
				if (s) for (u = o[o.length - 1].ownerDocument, d.map(o, le), l = 0; s > l; l++) a = o[l],
	...
	function (e, t) {
		d.fn[e] = function (e) {
			for (var n, r = [], i = d(e), s = i.length - 1, a = 0; s >= a; a++) n = a === s ? this: this.clone(!0),
			d(i[a])[t](n),
			o.apply(r, n.get());
	...
	function ve(e) {
		var t = f,
		n = ge[e];
		return n || ("none" !== (n = me(e, t)) && n || ((t = (he = (he || d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(), t.close(), n = me(e, t), he.detach()), ge[e] = n),
		n
	}
	var ye = /^margin/,
	...
	function we(e, t, n) {
		...
		n && ("" !== s || d.contains(e.ownerDocument, e) || (s = d.style(e, t)), xe.test(s) && ye.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)),
		void 0 !== s ? s + "": s
	}
	function Te(e, t) {
		return {
	...
	function Le(e, t, n, r, i) {
		for (var o = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)"margin" === n && (s += d.css(e, n + B[o], !0, i)),
		r ? ("content" === n && (s -= d.css(e, "padding" + B[o], !0, i)), "margin" !== n && (s -= d.css(e, "border" + B[o] + "Width", !0, i))) : (s += d.css(e, "padding" + B[o], !0, i), "padding" !== n && (s += d.css(e, "border" + B[o] + "Width", !0, i)));
		return s
	}
	function qe(e, t, n) {
		var r = !0,
	...
	d.extend({
		...
		style: function (e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i: u[t] : ("string" === (o = typeof n) && (i = ke.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(d.css(e, t)), o = "number"), void(null != n && n == n && ("number" !== o || d.cssNumber[a] || (n += "px"), c.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n))))
			}
		},
		css: function (e, t, n, r) {
			...
			"" === n || n ? (o = parseFloat(i), !0 === n || d.isNumeric(o) ? o || 0 : i) : i
		}
	}),
	...
	$e = [function (e, t, n) {
		...
		else for (r in g ? "hidden" in g && (h = g.hidden) : g = F.access(e, "fxshow", {}), o && (g.hidden = !h), h ? d(e).show() : c.done(function () {
			d(e).hide()
		}), c.done(function () {
			var t;
	...
	function Xe(e, t, n) {
		...
		} (c, l.opts.specialEasing); s > o; o++) if (r = $e[o].call(l, e, c, l.opts)) return r;
		return d.map(c, ze, l),
	...
	d.speed = function (e, t, n) {
		var r = e && "object" == typeof e ? d.extend({},
		e) : {
	...
	d.extend({
		...
		removeAttr: function (e, t) {
			var n, r, i = 0,
			o = t && t.match(A);
			if (o && 1 === e.nodeType) for (; n = o[i++];) r = d.propFix[n] || n,
	...
	d.each(d.expr.match.bool.source.match(/\w+/g), function (e, t) {
		...
		Ve[t] = function (e, t, r) {
			var i, o;
			return r || (o = Ve[t], Ve[t] = i, i = null != n(e, t, r) ? t.toLowerCase() : null, Ve[t] = o),
			i
		}
	});
	...
	d.extend({
		...
		prop: function (e, t, n) {
			var r, i, o = e.nodeType;
			if (e && 3 !== o && 8 !== o && 2 !== o) return (1 !== o || !d.isXMLDoc(e)) && (t = d.propFix[t] || t, i = d.propHooks[t]),
	...
	d.fn.extend({
		addClass: function (e) {
			...
			if (a) for (t = (e || "").match(A) || []; l > u; u++) if (r = 1 === (n = this[u]).nodeType && (n.className ? (" " + n.className + " ").replace(Ge, " ") : " ")) {
		...
		toggleClass: function (e, t) {
			var n = typeof e;
			return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(d.isFunction(e) ?
			function (n) {
				d(this).toggleClass(e.call(this, n, this.className, t), t)
			}: function () {
				if ("string" === n) for (var t, r = 0, i = d(this), o = e.match(A) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
	...
	d.extend({
		valHooks: {
			...
			select: {
				get: function (e) {
					for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, s = o ? null: [], a = o ? i + 1 : r.length, u = 0 > i ? a: o ? i: 0; a > u; u++) if (! (! (n = r[u]).selected && u !== i || (c.optDisabled ? n.disabled: null !== n.getAttribute("disabled")) || n.parentNode.disabled && d.nodeName(n.parentNode, "optgroup"))) {
	...
	try {
		et = location.href
	} catch(e) { (et = f.createElement("a")).href = "",
		et = et.href
	}
	function ct(e) {
		return function (t, n) {
			...
			if (d.isFunction(n)) for (; r = o[i++];)"+" === r[0] ? (r = r.slice(1) || "*", (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n)
		}
	}
	function ft(e, t, n, r) {
		var i = {},
	...
	d.extend({
		...
		ajax: function (e, t) {
			...
			t = t || {};
			var n, r, i, o, s, a, u, l, c = d.ajaxSetup({},
			t),
			f = c.context || c,
	...
	d.each(["get", "post"], function (e, t) {
		d[t] = function (e, n, r, i) {
			return d.isFunction(n) && (i = i || r, r = n, n = void 0),
			d.ajax({
				url: e,
				type: t,
				dataType: i,
	...
	d.fn.extend({
		...
		wrapInner: function (e) {
			return this.each(d.isFunction(e) ?
			function (t) {
	...
	d.fn.load = function (e, t, n) {
		...
		var r, i, o, s = this,
		a = e.indexOf(" ");
		return a >= 0 && (r = d.trim(e.slice(a)), e = e.slice(0, a)),
...
function () {
	...
	cr.nextHighestPowerOfTwo = function (t) {--t;
	...
	e.prototype.normalize = function () {
		var t = 0;
		this.left > this.right && (t = this.left, this.left = this.right, this.right = t),
		this.top > this.bottom && (t = this.top, this.top = this.bottom, this.bottom = t)
	},
	...
	i.prototype.intersects_segment = function (t, e, i, r) {
		...
		var n, s, a, o, h;
		for (h = 0; h < 4; h++) if (n = this.at(h, !0), s = this.at(h, !1), a = this.at(h + 1, !0), o = this.at(h + 1, !1), cr.segments_intersect(t, e, i, r, n, s, a, o)) return ! 0;
		return ! 1
	},
	i.prototype.intersects_quad = function (t) {
		...
		for (c = 0; c < 4; c++) for (l = 0; l < 4; l++) if (e = this.at(c, !0), i = this.at(c, !1), r = this.at(c + 1, !0), n = this.at(c + 1, !1), s = t.at(l, !0), a = t.at(l, !1), o = t.at(l + 1, !0), h = t.at(l + 1, !1), cr.segments_intersect(e, i, r, n, s, a, o, h)) return ! 0;
		return ! 1
	},
	cr.quad = i,
	...
	u.prototype.add = function (t) {
		if (l) this.s.has(t) || (this.s.add(t), this.cache_valid = !1);
			...
			var e = t.toString(),
			i = this.items;
			i ? i.hasOwnProperty(e) || (i[e] = t, this.item_count++, this.cache_valid = !1) : (this.items = {},
			this.items[e] = t, this.item_count = 1, this.cache_valid = !1)
		}
	},
	u.prototype.remove = function (t) {
		if (!this.isEmpty()) if (l) this.s.has(t) && (this.s.delete(t), this.cache_valid = !1);
		else if (this.items) {
			var e = t.toString(),
			i = this.items;
	...
	u.prototype.update_cache = function () {
		if (!this.cache_valid) {
			if (l) cr.clearArray(this.values_cache),
			p = this.values_cache,
			d = 0,
			this.s.forEach(f),
			p = null,
			d = 0;
				...
				var e, i = 0,
				r = this.items;
				if (r) for (e in r) r.hasOwnProperty(e) && (t[i++] = r[e])
			}
			this.cache_valid = !0
		}
	},
	...
	cr.arrayRemoveAll_set = function (t, e) {
		var i, r, n, s;
		for (i = 0, r = 0, n = t.length; i < n; ++i) s = t[i],
		e.has(s) || (t[r++] = s);
		cr.truncateArray(t, r)
	},
	...
	m.prototype.update_bbox = function () {
		for (var t, e, i, r = this.pts_cache, n = r[0], s = n, a = r[1], o = a, h = 1, c = this.pts_count; h < c; ++h) t = r[i = 2 * h],
		e = r[i + 1],
		t < n && (n = t),
		t > s && (s = t),
		e < a && (a = e),
	...
	m.prototype.cache_poly = function (t, e, i) {
		if (this.cache_width !== t || this.cache_height !== e || this.cache_angle !== i) {
			...
			u = this.pts_array,
			p = this.pts_cache;
			for (0 !== i && (c = Math.sin(i), l = Math.cos(i)), r = 0, a = this.pts_count; r < a; r++) s = (n = 2 * r) + 1,
			o = u[n] * t,
			h = u[s] * e,
			p[n] = o * l - h * c,
			p[s] = h * l + o * c;
	...
	m.prototype.intersects_poly = function (t, e, i) {
		...
		for (r = 0, a = this.pts_count; r < a; r++) for (s = (r + 1) % a * 2, u = b[n = 2 * r], p = b[n + 1], d = b[s], f = b[s + 1], o = 0, l = t.pts_count; o < l; o++) if (c = (o + 1) % l * 2, g = v[h = 2 * o] + e, y = v[h + 1] + i, m = v[c] + e, _ = v[c + 1] + i, cr.segments_intersect(u, p, d, f, g, y, m, _)) return ! 0;
		return ! 1
	},
	m.prototype.intersects_segment = function (t, e, i, r, n, s) {
		...
		for (a = 0, o = this.pts_count; a < o; a++) if (c = (a + 1) % o * 2, l = f[h = 2 * a] + t, u = f[h + 1] + e, p = f[c] + t, d = f[c + 1] + e, cr.segments_intersect(i, r, n, s, l, u, p, d)) return ! 0;
		return ! 1
	},
	m.prototype.mirror = function (t) {
		var e, i, r;
		for (e = 0, i = this.pts_count; e < i; ++e) r = 2 * e,
		this.pts_cache[r] = 2 * t - this.pts_cache[r]
	},
	m.prototype.flip = function (t) {
		var e, i, r;
		for (e = 0, i = this.pts_count; e < i; ++e) r = 2 * e + 1,
		this.pts_cache[r] = 2 * t - this.pts_cache[r]
	},
	m.prototype.diag = function () {
		var t, e, i, r, n;
		for (t = 0, e = this.pts_count; t < e; ++t) r = (i = 2 * t) + 1,
		n = this.pts_cache[i],
	...
	_.prototype.getCell = function (t, e, i) {
		...
		return n ? (r = n[e]) || (i ? (r = w(this, t, e), this.cells[t][e] = r, r) : null) : i ? (r = w(this, t, e), this.cells[t] = {},
		this.cells[t][e] = r, r) : null
	},
	...
	_.prototype.update = function (t, e, i) {
		var r, n, s, a, o;
		if (e) for (r = e.left, n = e.right; r <= n; ++r) for (s = e.top, a = e.bottom; s <= a; ++s) i && i.contains_pt(r, s) || (o = this.getCell(r, s, !1)) && (o.remove(t), o.isEmpty() && (x(o), this.cells[r][s] = null));
		if (i) for (r = i.left, n = i.right; r <= n; ++r) for (s = i.top, a = i.bottom; s <= a; ++s) e && e.contains_pt(r, s) || this.getCell(r, s, !0).insert(t)
	},
	_.prototype.queryRange = function (t, e) {
		var i, r, n, s, a, o;
		for (i = this.XToCell(t.left), n = this.YToCell(t.top), r = this.XToCell(t.right), a = this.YToCell(t.bottom); i <= r; ++i) for (s = n; s <= a; ++s)(o = this.getCell(i, s, !1)) && o.dump(e)
	},
	cr.SparseGrid = _,
	v.prototype.totalCellCount = 0,
	v.prototype.getCell = function (t, e, i) {
		var r, n = this.cells[t];
		return n ? (r = n[e]) || (i ? (r = O(this, t, e), this.cells[t][e] = r, r) : null) : i ? (r = O(this, t, e), this.cells[t] = {},
		this.cells[t][e] = r, r) : null
	},
	...
	v.prototype.update = function (t, e, i) {
		var r, n, s, a, o;
		if (e) for (r = e.left, n = e.right; r <= n; ++r) for (s = e.top, a = e.bottom; s <= a; ++s) i && i.contains_pt(r, s) || (o = this.getCell(r, s, !1)) && (o.remove(t), o.isEmpty() && (C(o), this.cells[r][s] = null));
		if (i) for (r = i.left, n = i.right; r <= n; ++r) for (s = i.top, a = i.bottom; s <= a; ++s) e && e.contains_pt(r, s) || this.getCell(r, s, !0).insert(t)
	},
	v.prototype.queryRange = function (t, e, i, r, n) {
		var s, a, o, h, c, l;
		for (s = this.XToCell(t), o = this.YToCell(e), a = this.XToCell(i), c = this.YToCell(r); s <= a; ++s) for (h = o; h <= c; ++h)(l = this.getCell(s, h, !1)) && l.dump(n)
	},
	v.prototype.markRangeChanged = function (t) {
		var e, i, r, n, s, a;
		for (e = t.left, r = t.top, i = t.right, s = t.bottom; e <= i; ++e) for (n = r; n <= s; ++n)(a = this.getCell(e, n, !1)) && (a.is_sorted = !1)
	},
	cr.RenderGrid = v;
	var b = [];
	function w(t, e, i) {
		...
		b.length ? ((r = b.pop()).grid = t, r.x = e, r.y = i, r) : new cr.GridCell(t, e, i)
	}
	function x(t) {
	...
	function O(t, e, i) {
		...
		T.length ? ((r = T.pop()).grid = t, r.x = e, r.y = i, r) : new cr.RenderCell(t, e, i)
	}
	function C(t) {
	...
	A.prototype.insert = function (t) {
		if (this.pending_removal.contains(t)) return this.pending_removal.remove(t),
...
mat4.multiply = function (t, e, i) {
	...
	i[12] = P * r + I * o + L * u + e * g,
	i[13] = P * n + I * h + L * p + e * y,
	i[14] = P * s + I * c + L * d + e * m,
	i[15] = P * a + I * l + L * f + e * t,
	i
},
...
mat4.rotateX = function (t, e, i) {
	...
	l = t[10],
	u = t[11];
	return i ? t !== i && (i[0] = t[0], i[1] = t[1], i[2] = t[2], i[3] = t[3], i[12] = t[12], i[13] = t[13], i[14] = t[14], i[15] = t[15]) : i = t,
	i[4] = n * e + h * r,
	i[5] = s * e + c * r,
	i[6] = a * e + l * r,
	i[7] = o * e + u * r,
...
mat4.rotateY = function (t, e, i) {
	...
	l = t[10],
	u = t[11];
	return i ? t !== i && (i[4] = t[4], i[5] = t[5], i[6] = t[6], i[7] = t[7], i[12] = t[12], i[13] = t[13], i[14] = t[14], i[15] = t[15]) : i = t,
	i[0] = n * e + h * -r,
	i[1] = s * e + c * -r,
	i[2] = a * e + l * -r,
	i[3] = o * e + u * -r,
...
mat4.rotateZ = function (t, e, i) {
	...
	l = t[6],
	u = t[7];
	return i ? t !== i && (i[8] = t[8], i[9] = t[9], i[10] = t[10], i[11] = t[11], i[12] = t[12], i[13] = t[13], i[14] = t[14], i[15] = t[15]) : i = t,
	i[0] = n * e + h * r,
	i[1] = s * e + c * r,
	i[2] = a * e + l * r,
	i[3] = o * e + u * r,
...
function () {
	...
	e.prototype.createShaderProgram = function (t, e, r) {
		...
		for (u.extendBoxHorizontal = t.extendBoxHorizontal || 0, u.extendBoxVertical = t.extendBoxVertical || 0, u.crossSampling = !!t.crossSampling, u.preservesOpaqueness = !!t.preservesOpaqueness, u.animated = !!t.animated, u.parameters = t.parameters || [], c = 0, l = u.parameters.length; c < l; c++) u.parameters[c][1] = n.getUniformLocation(h, u.parameters[c][0]),
	...
	e.prototype.getShaderIndex = function (t) {
		var e, i;
		for (e = 0, i = this.shaderPrograms.length; e < i; e++) if (this.shaderPrograms[e].name === t) return e;
		return - 1
	},
	e.prototype.project = function (t, e, i) {
		...
		s[7] = -s[2],
		0 !== s[7] && (s[7] = 1 / s[7], s[4] *= s[7], s[5] *= s[7], s[6] *= s[7], i[0] = (.5 * s[4] + .5) * this.width, i[1] = (.5 * s[5] + .5) * this.height)
	},
	e.prototype.setSize = function (t, e, i) {
		if (this.width !== t || this.height !== e || i) {
			this.endBatch();
			var r, n, s, a = this.gl;
			if (this.width = t, this.height = e, a.viewport(0, 0, t, e), mat4.lookAt(this.cam, this.look, this.up, this.matMV), this.enableFrontToBack) mat4.ortho( - t / 2, t / 2, e / 2, -e / 2, this.zNear, this.zFar, this.matP),
			this.worldScale[0] = 1,
			this.worldScale[1] = 1;
			else {
			...
			for (r = 0, n = this.shaderPrograms.length; r < n; r++)(s = this.shaderPrograms[r]).hasCurrentMatMV = !1,
			s.locMatP && (a.useProgram(s.shaderProgram), a.uniformMatrix4fv(s.locMatP, !1, this.matP));
	...
	n.prototype.doUpdateModelView = function () {
		...
		for (t = 0, e = r.length; t < e; t++) i = r[t],
		t === n && i.locMatMV ? (i.updateMatMV(this.mat4param), i.hasCurrentMatMV = !0) : i.hasCurrentMatMV = !1;
	...
	n.prototype.doPoints = function () {
		...
		!i.hasCurrentMatMV && i.locMatMV && (i.updateMatMV(e.currentMV), i.hasCurrentMatMV = !0),
		...
		i = e.currentShader,
		t.useProgram(i.shaderProgram),
		i.locAPos >= 0 && (t.enableVertexAttribArray(i.locAPos), t.bindBuffer(t.ARRAY_BUFFER, e.vertexBuffers[e.curBuffer]), t.vertexAttribPointer(i.locAPos, e.enableFrontToBack ? 3 : 2, t.FLOAT, !1, 0, 0)),
		i.locATex >= 0 && (t.enableVertexAttribArray(i.locATex), t.bindBuffer(t.ARRAY_BUFFER, e.texcoordBuffers[e.curBuffer]), t.vertexAttribPointer(i.locATex, 2, t.FLOAT, !1, 0, 0)),
	...
	n.prototype.doSetProgram = function () {
		...
		t.useProgram(i.shaderProgram),
		!i.hasCurrentMatMV && i.locMatMV && (i.updateMatMV(e.currentMV), i.hasCurrentMatMV = !0),
		i.locOpacity && i.lpOpacity !== e.currentOpacity && (i.lpOpacity = e.currentOpacity, t.uniform1f(i.locOpacity, e.currentOpacity)),
		i.locAPos >= 0 && (t.enableVertexAttribArray(i.locAPos), t.bindBuffer(t.ARRAY_BUFFER, e.vertexBuffers[e.curBuffer]), t.vertexAttribPointer(i.locAPos, e.enableFrontToBack ? 3 : 2, t.FLOAT, !1, 0, 0)),
		i.locATex >= 0 && (t.enableVertexAttribArray(i.locATex), t.bindBuffer(t.ARRAY_BUFFER, e.texcoordBuffers[e.curBuffer]), t.vertexAttribPointer(i.locATex, 2, t.FLOAT, !1, 0, 0))
	},
	...
	n.prototype.doSetProgramParameters = function () {
		...
		var s, a = n[0];
		if (i.locPixelWidth && a !== i.lpPixelWidth && (i.lpPixelWidth = a, r.uniform1f(i.locPixelWidth, a)), a = n[1], i.locPixelHeight && a !== i.lpPixelHeight && (i.lpPixelHeight = a, r.uniform1f(i.locPixelHeight, a)), a = n[2], s = n[3], !i.locDestStart || a === i.lpDestStartX && s === i.lpDestStartY || (i.lpDestStartX = a, i.lpDestStartY = s, r.uniform2f(i.locDestStart, a, s)), a = n[4], s = n[5], !i.locDestEnd || a === i.lpDestEndX && s === i.lpDestEndY || (i.lpDestEndX = a, i.lpDestEndY = s, r.uniform2f(i.locDestEnd, a, s)), a = n[6], i.locLayerScale && a !== i.lpLayerScale && (i.lpLayerScale = a, r.uniform1f(i.locLayerScale, a)), a = n[7], i.locLayerAngle && a !== i.lpLayerAngle && (i.lpLayerAngle = a, r.uniform1f(i.locLayerAngle, a)), a = n[8], s = n[9], !i.locViewOrigin || a === i.lpViewOriginX && s === i.lpViewOriginY || (i.lpViewOriginX = a, i.lpViewOriginY = s, r.uniform2f(i.locViewOrigin, a, s)), a = n[10], s = n[11], !i.locScrollPos || a === i.lpScrollPosX && s === i.lpScrollPosY || (i.lpScrollPosX = a, i.lpScrollPosY = s, r.uniform2f(i.locScrollPos, a, s)), a = n[12], i.locSeconds && a !== i.lpSeconds && (i.lpSeconds = a, r.uniform1f(i.locSeconds, a)), i.parameters.length) for (t = 0, e = i.parameters.length; t < e; t++)(a = this.shaderParams[t]) !== i.lastCustomParams[t] && (i.lastCustomParams[t] = a, r.uniform1f(i.parameters[t][1], a))
	},
	...
	e.prototype.quad = function (t, e, i, r, n, s, a, o) {
		...
		this.enableFrontToBack ? (l[h++] = t, l[h++] = e, l[h++] = p, l[h++] = i, l[h++] = r, l[h++] = p, l[h++] = n, l[h++] = s, l[h++] = p, l[h++] = a, l[h++] = o, l[h++] = p) : (l[h++] = t, l[h++] = e, l[h++] = i, l[h++] = r, l[h++] = n, l[h++] = s, l[h++] = a, l[h++] = o),
		u[c++] = 0,
		u[c++] = 0,
		u[c++] = 1,
		u[c++] = 0,
	...
	e.prototype.quadTex = function (t, e, i, r, n, s, a, o, h) {
		...
		m = h.right,
		_ = h.bottom;
		this.enableFrontToBack ? (u[c++] = t, u[c++] = e, u[c++] = d, u[c++] = i, u[c++] = r, u[c++] = d, u[c++] = n, u[c++] = s, u[c++] = d, u[c++] = a, u[c++] = o, u[c++] = d) : (u[c++] = t, u[c++] = e, u[c++] = i, u[c++] = r, u[c++] = n, u[c++] = s, u[c++] = a, u[c++] = o),
		p[l++] = g,
		p[l++] = y,
		p[l++] = m,
		p[l++] = y,
	...
	e.prototype.quadTexUV = function (t, e, i, r, n, s, a, o, h, c, l, u, p, d, f, g) {
		...
		this.enableFrontToBack ? (_[y++] = t, _[y++] = e, _[y++] = b, _[y++] = i, _[y++] = r, _[y++] = b, _[y++] = n, _[y++] = s, _[y++] = b, _[y++] = a, _[y++] = o, _[y++] = b) : (_[y++] = t, _[y++] = e, _[y++] = i, _[y++] = r, _[y++] = n, _[y++] = s, _[y++] = a, _[y++] = o),
		v[m++] = h,
		v[m++] = c,
		v[m++] = l,
		v[m++] = u,
	...
	e.prototype.convexPoly = function (t) {
		...
		u = t[0],
		p = t[1];
		for (e = 0; e < c; e += 2) r = t[(i = 2 * e) + 2],
		n = t[i + 3],
		s = t[i + 4],
		a = t[i + 5],
		e === l ? this.quad(u, p, r, n, s, a, s, a) : (o = t[i + 6], h = t[i + 7], this.quad(u, p, r, n, s, a, o, h))
	};
	...
	e.prototype.setProgramParameters = function (t, e, i, r, n, s, a, o, h, c, l, u, p, d, f) {
		...
		if (b.hasAnyOptionalUniforms || f.length) {
			if ((m = this.pushBatch()).type = 10, m.mat4param ? mat4.set(this.matMV, m.mat4param) : m.mat4param = mat4.create(), (_ = m.mat4param)[0] = e, _[1] = i, _[2] = r, _[3] = n, _[4] = s, _[5] = a, _[6] = o, _[7] = h, _[8] = c, _[9] = l, _[10] = u, _[11] = p, _[12] = d, b.locSamplerBack ? m.texParam = t: m.texParam = null, f.length) for ((v = m.shaderParams).length = f.length, g = 0, y = f.length; g < y; g++) v[g] = f[g];
			this.hasQuadBatchTop = !1,
			this.hasPointBatchTop = !1
		}
	},
	...
	e.prototype.loadTexture = function (t, e, i, r, n, o) {
		...
		var h = t.src + "," + e + "," + i + (e ? "," + n: ""),
		c = null;
		if (void 0 !== t.src && a.hasOwnProperty(h)) return (c = a[h]).c2refcount++,
		c;
		this.endBatch();
		var l = this.gl,
		...
		if (1 === this.version && !u && e) {
			...
			void 0 !== y.imageSmoothingEnabled ? y.imageSmoothingEnabled = i: (y.webkitImageSmoothingEnabled = i, y.mozImageSmoothingEnabled = i, y.msImageSmoothingEnabled = i),
		...
		i ? (l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MAG_FILTER, l.LINEAR), (u || this.version >= 2) && this.enable_mipmaps && !o ? (l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MIN_FILTER, l.LINEAR_MIPMAP_LINEAR), l.generateMipmap(l.TEXTURE_2D)) : l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MIN_FILTER, l.LINEAR)) : (l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MAG_FILTER, l.NEAREST), l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MIN_FILTER, l.NEAREST)),
	...
	e.prototype.createEmptyTexture = function (t, e, i, r, n) {
		...
		n ? (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.REPEAT), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.REPEAT)) : (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE)),
...
function () {
	...
	function e(t) {
		if (t && (t.getContext || t.dc) && !t.c2runtime) {
			...
			this.isMobile = false,//this.isCordova || this.isCrosswalk || this.isAppMobi || this.isCocoonJs || this.isAndroid || this.isiOS || this.isWindowsPhone8 || this.isWindowsPhone81 || this.isBlackberry10 || this.isTizen || this.isEjecta,
	...
	e.prototype.initRendererAndLoader = function () {
		...
		if (this.gl) {
			...
			for (t = 0, e = this.layouts_by_index.length; t < e; t++) {
				for (i = 0, r = (h = this.layouts_by_index[t]).effect_types.length; i < r; i++)(o = h.effect_types[i]).shaderindex = this.glwrap.getShaderIndex(o.id),
				o.preservesOpaqueness = this.glwrap.programPreservesOpaqueness(o.shaderindex);
				for (h.updateActiveEffects(), i = 0, r = h.layers.length; i < r; i++) {
					for (n = 0, s = (c = h.layers[i]).effect_types.length; n < s; n++)(o = c.effect_types[n]).shaderindex = this.glwrap.getShaderIndex(o.id),
					o.preservesOpaqueness = this.glwrap.programPreservesOpaqueness(o.shaderindex),
					this.uses_background_blending = this.uses_background_blending || this.glwrap.programUsesDest(o.shaderindex);
			...
			this.ctx = this.canvas.getContext("2d", l)), this.setCtxImageSmoothingEnabled(this.ctx, this.linearSampling)),
	...
	e.prototype.setSize = function (t, e, i) {
		...
		if (this.lastWindowWidth !== t || this.lastWindowHeight !== e || i) {
			...
			if (u || 0 !== this.fullscreen_mode || i) {
				...
				this.canvas && (this.canvas.width = Math.round(t * p), this.canvas.height = Math.round(e * p), this.isEjecta ? (this.canvas.style.left = Math.floor(r) + "px", this.canvas.style.top = Math.floor(n) + "px", this.canvas.style.width = Math.round(t) + "px", this.canvas.style.height = Math.round(e) + "px") : this.isRetina && !this.isDomFree && (this.canvas.style.width = Math.round(t) + "px", this.canvas.style.height = Math.round(e) + "px")),
				this.overlay_canvas && (this.overlay_canvas.width = Math.round(t * p), this.overlay_canvas.height = Math.round(e * p), this.overlay_canvas.style.width = this.cssWidth + "px", this.overlay_canvas.style.height = this.cssHeight + "px"),
				this.glwrap && this.glwrap.setSize(Math.round(t * p), Math.round(e * p)),
				this.isDirectCanvas && this.ctx && (this.ctx.width = Math.round(t), this.ctx.height = Math.round(e)),
	...
	e.prototype.tryLockOrientation = function () {
		if (this.autoLockOrientation && 0 !== this.orientations) {
			...
			try {
				screen.orientation && screen.orientation.lock ? screen.orientation.lock(t).
				catch(function () {}) : screen.lockOrientation ? screen.lockOrientation(t) : screen.webkitLockOrientation ? screen.webkitLockOrientation(t) : screen.mozLockOrientation ? screen.mozLockOrientation(t) : screen.msLockOrientation && screen.msLockOrientation(t)
			} catch(t) {
	...
	e.prototype.setSuspended = function (t) {
		var e, r;
		if (t && !this.isSuspended) for (cr.logexport("[Construct 2] Suspending"), this.isSuspended = !0, -1 !== this.raf_id && i && i(this.raf_id), -1 !== this.timeout_id && clearTimeout(this.timeout_id), e = 0, r = this.suspend_events.length; e < r; e++) this.suspend_events[e](!0);
	...
	e.prototype.loadProject = function (t) {
		...
		for (this.next_uid = f[21], this.objectRefTable = cr.getObjectRefTable(), this.system = new cr.system_object(this), e = 0, i = f[2].length; e < i; e++) o = f[2][e],
		...
		for (this.objectRefTable = cr.getObjectRefTable(), e = 0, i = f[3].length; e < i; e++) {
			...
			if (k.tile_poly_data = o[13], this.uses_loader_layout && !k.is_family && !k.isOnLoaderLayout && p.is_world || (k.onCreate(), cr.seal(k)), k.name && (this.types[k.name] = k), this.types_by_index.push(k), p.singleglobal) {
				var L = new p.Instance(k);
				L.uid = this.next_uid++,
				L.puid = this.next_puid++,
				L.iid = 0,
				L.get_iid = cr.inst_get_iid,
				L.toString = cr.inst_toString,
				L.properties = o[14],
				L.onCreate(),
				cr.seal(L),
				k.instances.push(L),
				this.objectsByUid[L.uid.toString()] = L
			}
		}
		for (e = 0, i = f[4].length; e < i; e++) {
			var R, N = f[4][e],
			B = this.types_by_index[N[0]];
			for (r = 1, n = N.length; r < n; r++)(R = this.types_by_index[N[r]]).families.push(B),
			B.members.push(R)
		}
		for (e = 0, i = f[28].length; e < i; e++) {
			...
			for (r = 0, n = F.length; r < n; r++) F[r].is_contained = !0,
			F[r].container = F
		}
		if (this.family_count > 0) for (e = 0, i = this.types_by_index.length; e < i; e++) if (! (c = this.types_by_index[e]).is_family && c.families.length) {
			...
			W = 0,
			G = 0;
			for (r = 0, n = c.families.length; r < n; r++) for (l = c.families[r], c.family_var_map[l.family_index] = D, D += l.vars_count, c.family_beh_map[l.family_index] = W, W += l.behs_count, c.family_fx_map[l.family_index] = G, G += l.fx_count, s = 0, a = l.effect_types.length; s < a; s++) j.push(cr.shallowCopy({},
			l.effect_types[s]));
	...
	e.prototype.waitForImageLoad = function (t, e) {
		...
		}) : (t.crossOrigin = "anonymous", this.queueImageLoad(t, e))),
	...
	e.prototype.areAllTexturesAndSoundsLoaded = function () {
		...
		return h && this.preloadSounds && this.audioInstance && (o || (this.audioInstance.startPreloads(), o = !0), n += s = this.audioInstance.getPreloadedSize(), s < a && (h = !1)),
			...
			if (this.areAllTexturesAndSoundsLoaded() && (4 !== this.loaderstyle || h)) this.go_loading_finished();
				...
				if (e) {
					...
					if (this.loaderstyle < 3 && (this.isCocoonJs || a >= 500 && this.last_progress != this.progress)) {
						...
						if (this.loaderstyle <= 1) d += y + (f ? 12 * l: 0),
						p -= g,
						p = cr.floor(p) + .5,
						d = cr.floor(d) + .5,
					...
					} else if (4 === this.loaderstyle) return this.draw_c2_splash_loader(e),
					void(t ? t(function () {
						s.go()
					}) : setTimeout(function () {
						s.go()
	...
	e.prototype.draw_c2_splash_loader = function (t) {
		if (!h) {
			for (var e = Math.ceil(this.width), i = Math.ceil(this.height), n = (this.devicePixelRatio, this.loaderlogos.logo), s = this.loaderlogos.powered, a = this.loaderlogos.website, o = 0; o < 4; ++o) if (!n[o].complete || !s[o].complete || !a[o].complete) return;
			0 === _ && (c = Date.now());
			var b, w, x = Date.now(),
			S = !1,
			T = t;
		...
		if (this.running_layout) {
			...
			if (r || !this.isSuspended || e) {
				...
				if (this.isDomFree || (h ? this.firstInFullscreen || (this.firstInFullscreen = !0) : this.firstInFullscreen ? (this.firstInFullscreen = !1, 0 === this.fullscreen_mode && this.setSize(Math.round(this.oldWidth / this.devicePixelRatio), Math.round(this.oldHeight / this.devicePixelRatio), !0)) : (this.oldWidth = this.width, this.oldHeight = this.height)), this.isloading) {
					...
					u && (this.isloading = !1, this.progress = 1, this.trigger(cr.system_object.prototype.cnds.OnLoadFinished, null), window.C2_RegisterSW && window.C2_RegisterSW())
				}
				this.logic(a),
				!this.redraw && !this.isCocoonJs || this.is_WebGL_context_lost || this.suspendDrawing || e || (this.redraw = !1, this.glwrap ? this.drawGL() : this.draw(), this.snapshotCanvas && (this.canvas && this.canvas.toDataURL && (this.snapshotData = this.canvas.toDataURL(this.snapshotCanvas[0], this.snapshotCanvas[1]), window.cr_onSnapshot && window.cr_onSnapshot(this.snapshotData), this.trigger(cr.system_object.prototype.cnds.OnCanvasSnapshot, null)), this.snapshotCanvas = null)),
				this.hit_breakpoint || (this.tickcount++, this.tickcount_nosave++, this.execcount++, this.framecount++),
	...
	e.prototype.logic = function (t) {
		...
		if (this.fullscreen_mode >= 2 || u && this.fullscreen_scaling > 0) {
			...
			this.running_layout && (this.running_layout.scrollToX(this.running_layout.scrollX), this.running_layout.scrollToY(this.running_layout.scrollY))
		...
		for (e = 0, i = this.types_by_index.length; e < i; e++) if (! (o = this.types_by_index[e]).is_family && (o.behaviors.length || o.families.length)) for (r = 0, n = o.instances.length; r < n; r++) for (s = 0, a = (y = o.instances[r]).behavior_insts.length; s < a; s++) y.behavior_insts[s].tick();
		for (e = 0, i = this.types_by_index.length; e < i; e++) if (! (o = this.types_by_index[e]).is_family && (o.behaviors.length || o.families.length)) for (r = 0, n = o.instances.length; r < n; r++) for (s = 0, a = (y = o.instances[r]).behavior_insts.length; s < a; s++)(h = y.behavior_insts[s]).posttick && h.posttick();
		...
		for (this.running_layout.event_sheet && this.running_layout.event_sheet.run(), cr.clearArray(this.registered_collisions), this.layout_first_tick = !1, this.isInOnDestroy++, e = 0, i = this.types_by_index.length; e < i; e++) if (! (o = this.types_by_index[e]).is_family && (o.behaviors.length || o.families.length)) for (r = 0, n = o.instances.length; r < n; r++) {
			var y;
	...
	e.prototype.onWindowBlur = function () {
		...
		for (t = 0, e = this.types_by_index.length; t < e; t++) if (! (a = this.types_by_index[t]).is_family) for (i = 0, r = a.instances.length; i < r; i++) if ((o = a.instances[i]).onWindowBlur && o.onWindowBlur(), o.behavior_insts) for (n = 0, s = o.behavior_insts.length; n < s; n++)(h = o.behavior_insts[n]).onWindowBlur && h.onWindowBlur()
	},
	e.prototype.doChangeLayout = function (t) {
		var e, i, r, n = this.running_layout;
		if (this.running_layout.stopRunning(), this.glwrap) for (e = 0, i = this.types_by_index.length; e < i; e++)(r = this.types_by_index[e]).is_family || !r.unloadTextures || r.global && 0 !== r.instances.length || -1 !== t.initial_types.indexOf(r) || r.unloadTextures();
	...
	e.prototype.runLayoutChangeMethods = function (t) {
		...
		for (e = 0, i = this.behaviors.length; e < i; e++) r = this.behaviors[e],
		t ? r.onBeforeLayoutChange && r.onBeforeLayoutChange() : r.onLayoutChange && r.onLayoutChange();
		for (e = 0, i = this.types_by_index.length; e < i; e++) if ((n = this.types_by_index[e]).global || n.plugin.singleglobal) for (s = 0, a = n.instances.length; s < a; s++) if (o = n.instances[s], t ? o.onBeforeLayoutChange && o.onBeforeLayoutChange() : o.onLayoutChange && o.onLayoutChange(), o.behavior_insts) for (h = 0, c = o.behavior_insts.length; h < c; h++) l = o.behavior_insts[h],
	...
	e.prototype.drawGL = function () {
		this.enableFrontToBack && (this.earlyz_index = 1, this.running_layout.drawGL_earlyZPass(this.glwrap)),
	...
	e.prototype.DestroyInstance = function (t) {
		...
		} else n = b.length ? b.pop() : new cr.ObjectSet,
		this.deathRow[r] = n;
		if (n.add(t), this.hasPendingInstances = !0, t.is_contained) for (e = 0, i = t.siblings.length; e < i; e++) this.DestroyInstance(t.siblings[e]);
		this.isInClearDeathRow && n.values_cache.push(t),
		this.isEndingLayout || (this.isInOnDestroy++, this.trigger(Object.getPrototypeOf(t.type.plugin).cnds.OnDestroyed, t), this.isInOnDestroy--)
	},
	e.prototype.ClearDeathRow = function () {
		if (this.hasPendingInstances) {
			var t, e, i, r, n, s;
			for (this.isInClearDeathRow = !0, i = 0, n = this.createRow.length; i < n; ++i) for ((e = (t = this.createRow[i]).type).instances.push(t), r = 0, s = e.families.length; r < s; ++r) e.families[r].instances.push(t),
	...
	e.prototype.ClearDeathRowForType = function (t) {
		...
		l = c[0].type;
		for (cr.arrayRemoveAllFromObjectSet(l.instances, t), l.stale_iids = !0, 0 === l.instances.length && (l.any_instance_parallaxed = !1), e = 0, i = l.families.length; e < i; ++e) a = l.families[e],
		cr.arrayRemoveAllFromObjectSet(a.instances, t),
		a.stale_iids = !0;
		for (e = 0, i = this.system.waits.length; e < i; ++e) if ((s = this.system.waits[e]).sols.hasOwnProperty(l.index) && cr.arrayRemoveAllFromObjectSet(s.sols[l.index].insts, t), !l.is_family) for (r = 0, n = l.families.length; r < n; ++r) a = l.families[r],
		s.sols.hasOwnProperty(a.index) && cr.arrayRemoveAllFromObjectSet(s.sols[a.index].insts, t);
		var u, p = c[0].layer;
		if (p) {
			if (p.useRenderCells) for (e = 0, i = (o = p.instances).length; e < i; ++e) h = o[e],
			t.contains(h) && (h.update_bbox(), p.render_grid.update(h, h.rendercells, null), h.rendercells.set(0, 0, -1, -1));
	...
	e.prototype.ClearDeathRowForSingleInstance = function (t, e) {
		...
		var s = t.layer;
		if (s && s.removeFromInstanceList(t, !0), t.behavior_insts) for (i = 0, r = t.behavior_insts.length; i < r; ++i)(n = t.behavior_insts[i]).onDestroy && n.onDestroy(),
	...
	e.prototype.createInstanceFromInit = function (t, e, i, r, n, s) {
		...
		if (d.recycled) cr.wipe(d.extra);
			...
			if (d.extra = {},
			"undefined" != typeof cr_is_preview) for (d.instance_var_names = [], d.instance_var_names.length = y.length, a = 0, o = y.length; a < o; a++) d.instance_var_names[a] = y[a][1];
			d.instance_vars = [],
		...
		if (p) {
			...
			if (d.x = cr.is_undefined(r) ? m[0] : r, d.y = cr.is_undefined(n) ? m[1] : n, d.z = m[2], d.width = m[3], d.height = m[4], d.depth = m[5], d.angle = m[6], d.opacity = m[7], d.hotspotX = m[8], d.hotspotY = m[9], d.blend_mode = m[10], l = m[11], !this.glwrap && u.effect_types.length && (d.blend_mode = l), d.compositeOp = cr.effectToCompositeOp(d.blend_mode), this.gl && cr.setGLBlend(d, d.blend_mode, this.gl), d.recycled) {
				for (a = 0, o = m[12].length; a < o; a++) for (h = 0, c = m[12][a].length; h < c; h++) d.effect_params[a][h] = m[12][a][h];
				d.bbox.set(0, 0, 0, 0),
		...
		if (w.push.apply(w, u.behaviors), d.recycled) for (a = 0, o = w.length; a < o; a++) {
			var _ = w[a];
		...
		} else for (d.behavior_insts = [], a = 0, o = w.length; a < o; a++) {
			var v;
		...
		if (g = t[5], d.recycled) for (a = 0, o = g.length; a < o; a++) d.properties[a] = g[a];
		...
		if (this.createRow.push(d), this.hasPendingInstances = !0, e && (e.appendToInstanceList(d, !0), 1 === e.parallaxX && 1 === e.parallaxY || (u.any_instance_parallaxed = !0)), this.objectcount++, u.is_contained) {
			if (d.is_contained = !0, d.recycled ? cr.clearArray(d.siblings) : d.siblings = [], !i && !s) {
				for (a = 0, o = u.container.length; a < o; a++) if (u.container[a] !== u) {
				...
				for (a = 0, o = d.siblings.length; a < o; a++) for (d.siblings[a].siblings.push(d), h = 0; h < o; h++) a !== h && d.siblings[a].siblings.push(d.siblings[h])
			}
		} else d.is_contained = !1,
		d.siblings = null;
	...
	e.prototype.getCollisionCandidates = function (t, e, i, r) {
		...
		if (e.is_family) for (n = 0, s = e.members.length; n < s; ++n) a = e.members[n],
		o || a.any_instance_parallaxed ? cr.appendArray(r, a.instances) : (this.updateAllCells(a), a.collision_grid.queryRange(i, r));
	...
	e.prototype.testAndSelectCanvasPointOverlap = function (t, e, i, r) {
		...
		if (u.select_all) for (r || (u.select_all = !1, cr.clearArray(u.instances)), n = 0, o = t.instances.length; n < o; n++) if ((a = t.instances[n]).update_bbox(), h = a.layer.canvasToLayer(e, i, !0), c = a.layer.canvasToLayer(e, i, !1), a.contains_pt(h, c)) {
			if (r) return ! 1;
			u.instances.push(a)
		} else p && u.else_instances.push(a);
		else {
			for (s = 0, n = 0, o = (l = p ? u.else_instances: u.instances).length; n < o; n++) if ((a = l[n]).update_bbox(), h = a.layer.canvasToLayer(e, i, !0), c = a.layer.canvasToLayer(e, i, !1), a.contains_pt(h, c)) {
				if (r) return ! 1;
	...
	e.prototype.testTilemapOverlap = function (t, e) {
		...
		for (i = 0, r = c.length; i < r; ++i) if (s = (n = c[i]).rc, a.intersects_rect_off(s, o, h) && (x.set_from_rect(s), x.offset(o, h), x.intersects_quad(e.bquad))) if (l) {
			if (e.collision_poly.cache_poly(e.width, e.height, e.angle), n.poly) {
				if (n.poly.intersects_poly(e.collision_poly, e.x - (o + s.left), e.y - (h + s.top))) return cr.clearArray(T),
				!0
			} else if (this.temp_poly.set_from_quad(x, 0, 0, s.right - s.left, s.bottom - s.top), this.temp_poly.intersects_poly(e.collision_poly, e.x, e.y)) return cr.clearArray(T),
			!0
		} else {
			if (!n.poly) return cr.clearArray(T),
			!0;
			if (this.temp_poly.set_from_quad(e.bquad, 0, 0, e.width, e.height), n.poly.intersects_poly(this.temp_poly, -(o + s.left), -(h + s.top))) return cr.clearArray(T),
			!0
		}
	...
	e.prototype.testRectOverlap = function (t, e) {
		...
		if (e.tilemap_exists) {
			...
			o = e.x,
			h = e.y;
			for (i = 0, r = a.length; i < r; ++i) if (s = (n = a[i]).rc, t.intersects_rect_off(s, o, h)) {
				if (!n.poly) return cr.clearArray(T),
				!0;
				if (this.temp_poly.set_from_rect(t, 0, 0), n.poly.intersects_poly(this.temp_poly, -(o + s.left), -(h + s.top))) return cr.clearArray(T),
				!0
			}
			return cr.clearArray(T),
			!1
		...
		!!e.bquad.intersects_quad(x) && (!(e.collision_poly && !e.collision_poly.is_empty()) || (e.collision_poly.cache_poly(e.width, e.height, e.angle), x.offset( - t.left, -t.top), this.temp_poly.set_from_quad(x, 0, 0, 1, 1), e.collision_poly.intersects_poly(this.temp_poly, t.left - e.x, t.top - e.y)))
	},
	e.prototype.testSegmentOverlap = function (t, e, i, r, n) {
		...
		if (n.tilemap_exists) {
			...
			l = n.x,
			u = n.y;
			for (s = 0, a = c.length; s < a; ++s) if (h = (o = c[s]).rc, S.intersects_rect_off(h, l, u) && (x.set_from_rect(h), x.offset(l, u), x.intersects_segment(t, e, i, r))) {
				if (!o.poly) return cr.clearArray(T),
				!0;
				if (o.poly.intersects_segment(l + h.left, u + h.top, t, e, i, r)) return cr.clearArray(T),
				!0
			}
			return cr.clearArray(T),
			!1
	...
	e.prototype.typeHasBehavior = function (t, e) {
		if (!e) return ! 1;
		var i, r, n, s, a;
		for (i = 0, r = t.behaviors.length; i < r; i++) if (t.behaviors[i].behavior instanceof e) return ! 0;
		if (!t.is_family) for (i = 0, r = t.families.length; i < r; i++) for (n = 0, s = (a = t.families[i]).behaviors.length; n < s; n++) if (a.behaviors[n].behavior instanceof e) return ! 0;
		return ! 1
	},
	...
	e.prototype.testOverlapSolid = function (t) {
		var e, i, r;
		for (t.update_bbox(), this.getSolidCollisionCandidates(t.layer, t.bbox, O), e = 0, i = O.length; e < i; ++e) if ((r = O[e]).extra.solidEnabled && this.testOverlap(t, r)) return cr.clearArray(O),
		r;
	...
	e.prototype.testRectOverlapSolid = function (t) {
		var e, i, r;
		for (this.getSolidCollisionCandidates(null, t, O), e = 0, i = O.length; e < i; ++e) if ((r = O[e]).extra.solidEnabled && this.testRectOverlap(t, r)) return cr.clearArray(O),
		r;
		return cr.clearArray(O),
		null
	};
	...
	e.prototype.testOverlapJumpThru = function (t, e) {
		var i, r, n, s = null;
		for (e && (s = C, cr.clearArray(s)), t.update_bbox(), this.getJumpthruCollisionCandidates(t.layer, t.bbox, O), i = 0, r = O.length; i < r; ++i) if ((n = O[i]).extra.jumpthruEnabled && this.testOverlap(t, n)) {
			if (!e) return cr.clearArray(O),
			n;
			s.push(n)
		}
		return cr.clearArray(O),
	...
	e.prototype.pushOutSolid = function (t, e, i, r, n, s) {
		...
		l = null,
		u = null;
		for (a = 0; a < o; a++) if (t.x = h + e * a, t.y = c + i * a, t.set_bbox_changed(), !this.testOverlap(t, l) && ((l = this.testOverlapSolid(t)) && (u = l), !l && (n && (l = s ? this.testOverlap(t, s) ? s: null: this.testOverlapJumpThru(t)) && (u = l), !l))) return u && this.pushInFractional(t, e, i, u, 16),
		!0;
		return t.x = h,
		t.y = c,
		t.set_bbox_changed(),
	...
	e.prototype.pushOut = function (t, e, i, r, n) {
		...
		o = t.x,
		h = t.y;
		for (s = 0; s < a; s++) if (t.x = o + e * s, t.y = h + i * s, t.set_bbox_changed(), !this.testOverlap(t, n)) return ! 0;
		return t.x = o,
		t.y = h,
		t.set_bbox_changed(),
		!1
	...
	e.prototype.pushInFractional = function (t, e, i, r, n) {
		for (var s, a = 2, o = !1, h = !1, c = t.x, l = t.y; a <= n;) s = 1 / a,
		a *= 2,
		t.x += e * s * (o ? 1 : -1),
		t.y += i * s * (o ? 1 : -1),
		t.set_bbox_changed(),
		this.testOverlap(t, r) ? (o = !0, h = !0) : (o = !1, h = !1, c = t.x, l = t.y);
	...
	e.prototype.checkRegisteredCollision = function (t, e) {
		var i, r, n;
		for (i = 0, r = this.registered_collisions.length; i < r; i++) if ((n = this.registered_collisions[i])[0] === t && n[1] === e || n[0] === e && n[1] === t) return ! 0;
		return ! 1
	},
	e.prototype.calculateSolidBounceAngle = function (t, e, i, r) {
		...
		var c, l, u, p, d = h,
		f = cr.to_radians(5);
		for (c = 1; c < 36; c++) if (l = o - c * f, t.x = e + Math.cos(l) * a, t.y = i + Math.sin(l) * a, t.set_bbox_changed(), !this.testOverlap(t, d) && !(d = r ? null: this.testOverlapSolid(t))) {
			u = l;
			break
		}
	...
	e.prototype.trigger = function (t, e, i) {
		...
		for (s = 0, a = h.length; s < a; ++s) n = this.triggerOnSheet(t, e, h[s], i),
		o = o || n;
	...
	e.prototype.triggerOnSheet = function (t, e, i, r) {
		var n, s, a, o, h = !1;
		if (e) for (a = this.triggerOnSheetForTypeName(t, e, e.type.name, i, r), h = h || a, n = 0, s = (o = e.type.families).length; n < s; ++n) a = this.triggerOnSheetForTypeName(t, e, o[n].name, i, r),
		h = h || a;
		else a = this.triggerOnSheetForTypeName(t, e, "system", i, r),
		h = h || a;
		return h
	},
	e.prototype.triggerOnSheetForTypeName = function (t, e, i, r, n) {
		...
		if (!p) return c;
		var d, f = null;
		for (s = 0, a = p.length; s < a; ++s) if (p[s].method == t) {
			f = p[s].evs;
			break
		}
		if (!f) return c;
		if (! (d = u ? f[n] : f)) return null;
		for (s = 0, a = d.length; s < a; s++) o = d[s][0],
		h = d[s][1],
	...
	e.prototype.executeSingleTrigger = function (t, e, i, r) {
		...
		var u = !0;
		if (i.parent) {
			for (var p = c.temp_parents_arr, d = i.parent; d;) p.push(d),
			d = d.parent;
			for (p.reverse(), n = 0, s = p.length; n < s; n++) if (!p[n].run_pretrigger()) {
				u = !1;
				break
			}
		}
	...
	e.prototype.getEventVariableByName = function (t, e) {
		for (var i, r, n, s, a, o; e;) {
			for (i = 0, r = e.subevents.length; i < r; i++) if ((o = e.subevents[i]) instanceof cr.eventvariable && cr.equals_nocase(t, o.name)) return o;
			e = e.parent
		}
		for (i = 0, r = this.eventsheets_by_index.length; i < r; i++) for (n = 0, s = (a = this.eventsheets_by_index[i]).events.length; n < s; n++) if ((o = a.events[n]) instanceof cr.eventvariable && cr.equals_nocase(t, o.name)) return o;
		return null
	},
	...
	e.prototype.handleSaveLoad = function () {
		...
		if (this.signalledContinuousPreview && (n = !0, e = "__c2_continuouspreview", this.signalledContinuousPreview = !1), e.length) {
			if (this.ClearDeathRow(), i = this.saveToJSONString(), k() && !this.isCocoonJs) !
			function (t, e, i, r) {
				try {
		...
		if (r.length) {
			...
			function (t, e, i) {
				...
				e ? (t.loadFromJson = e, cr.logexport("Loaded state from IndexedDB storage (" + t.loadFromJson.length + " bytes)")) : (t.loadFromJson = localStorage.getItem("__c2save_" + r) || "", cr.logexport("Loaded state from WebStorage (" + t.loadFromJson.length + " bytes)")),
				t.suspendDrawing = !1,
				t.loadFromJson || (t.loadFromJson = null, t.trigger(cr.system_object.prototype.cnds.OnLoadFailed, null))
			},
			function (e) {
	...
	e.prototype.saveToJSONString = function () {
		...
		for (t = 0, e = this.types_by_index.length; t < e; t++) if (! (n = this.types_by_index[t]).is_family && !this.typeHasNoSaveBehavior(n)) {
			for (a = {
				instances: []
			},
			cr.hasAnyOwnProperty(n.extra) && (a.ex = I(n.extra)), i = 0, r = n.instances.length; i < r; i++) a.instances.push(this.saveInstanceToJSON(n.instances[i]));
			p.types[n.sid.toString()] = a
		}
		for (t = 0, e = this.layouts_by_index.length; t < e; t++) s = this.layouts_by_index[t],
	...
	e.prototype.refreshUidMap = function () {
		...
		t = 0, e = this.types_by_index.length; t < e; t++) if (! (i = this.types_by_index[t]).is_family) for (r = 0, n = i.instances.length; r < n; r++) s = i.instances[r],
	...
	e.prototype.loadFromJSONString = function (t) {
		...
		for (c in x) if (x.hasOwnProperty(c)) {
			...
			for (r = u.length, n = p.length; r < n; r++) y = null,
			l.plugin.is_world && !(y = this.running_layout.getLayerBySid(p[r].w.l)) || (d = this.createInstanceFromInit(l.default_instance, y, !1, 0, 0, !0), this.loadInstanceFromJSON(d, p[r]));
			l.stale_iids = !0
		}
		this.ClearDeathRow(),
		this.refreshUidMap();
		...
		for (this.next_uid = i.next_uid, this.isLoadingState = !1, r = 0, n = this.fireOnCreateAfterLoad.length; r < n; ++r) d = this.fireOnCreateAfterLoad[r],
		this.trigger(Object.getPrototypeOf(d.type.plugin).cnds.OnCreated, d);
		for (cr.clearArray(this.fireOnCreateAfterLoad), this.system.loadFromJSON(e.system), r = 0, n = this.types_by_index.length; r < n; r++) if (! (l = this.types_by_index[r]).is_family && !this.typeHasNoSaveBehavior(l)) for (s = 0, a = l.instances.length; s < a; s++) {
			if (d = l.instances[s], l.is_contained) for (_ = d.get_iid(), cr.clearArray(d.siblings), o = 0, h = l.container.length; o < h; o++) l !== (v = l.container[o]) && d.siblings.push(v.instances[_]);
			if (d.afterLoad && d.afterLoad(), d.behavior_insts) for (o = 0, h = d.behavior_insts.length; o < h; o++)(f = d.behavior_insts[o]).afterLoad && f.afterLoad()
		}
	...
	e.prototype.saveInstanceToJSON = function (t, e) {
		...
		h = o.plugin,
		c = {};
		if (e ? c.c2 = !0 : c.uid = t.uid, cr.hasAnyOwnProperty(t.extra) && (c.ex = I(t.extra)), t.instance_vars && t.instance_vars.length) for (c.ivs = {},
		i = 0, r = t.instance_vars.length; i < r; i++) c.ivs[t.type.instvar_sids[i].toString()] = t.instance_vars[i];
		if (h.is_world) {
			if (n = {
				x: t.x,
				y: t.y,
			...
			0 !== t.angle && (n.a = t.angle), 1 !== t.opacity && (n.o = t.opacity), .5 !== t.hotspotX && (n.hX = t.hotspotX), .5 !== t.hotspotY && (n.hY = t.hotspotY), 0 !== t.blend_mode && (n.bm = t.blend_mode), t.visible || (n.v = t.visible), t.collisionsEnabled || (n.ce = t.collisionsEnabled), -1 !== t.my_timescale && (n.mts = t.my_timescale), o.effect_types.length) for (n.fx = [], i = 0, r = o.effect_types.length; i < r; i++) a = o.effect_types[i],
			n.fx.push({
				name: a.name,
		...
		if (t.behavior_insts && t.behavior_insts.length) for (c.behs = {},
		i = 0, r = t.behavior_insts.length; i < r; i++)(s = t.behavior_insts[i]).saveToJSON && (c.behs[s.type.sid.toString()] = s.saveToJSON());
		return t.saveToJSON && (c.data = t.saveToJSON()),
		c
	},
	e.prototype.getInstanceVarIndexBySid = function (t, e) {
		var i, r;
		for (i = 0, r = t.instvar_sids.length; i < r; i++) if (t.instvar_sids[i] === e) return i;
		return - 1
	},
	e.prototype.getBehaviorIndexBySid = function (t, e) {
		var i, r;
		for (i = 0, r = t.behavior_insts.length; i < r; i++) if (t.behavior_insts[i].type.sid === e) return i;
		return - 1
	},
	e.prototype.loadInstanceFromJSON = function (t, e, i) {
		...
		if (e.ex ? t.extra = e.ex: cr.wipe(t.extra), o = e.ivs) for (r in o) if (o.hasOwnProperty(r)) {
		...
		if (l = e.behs) for (r in l) if (l.hasOwnProperty(r)) {
...
function () {
	...
	t.prototype.getEffectByName = function (t) {
		var e, i, r;
		for (e = 0, i = this.effect_types.length; e < i; e++) if ((r = this.effect_types[e]).name === t) return r;
		return null
	};
	var e = [];
	function i(t, e) {
	...
	t.prototype.startRunning = function () {
		...
		if (!r) for (t = 0, s = this.layers.length; t < s; ++t) this.layers[t].instances.sort(i);
		for (cr.clearArray(e), this.boundScrolling(), t = 0, s = this.layers.length; t < s; t++)(y = this.layers[t]).createInitialInstances(),
		y.updateViewport(null);
		var _ = !1;
		if (!this.first_visit) {
			for (f in this.persist_data) if (this.persist_data.hasOwnProperty(f)) {
				if (! (o = this.runtime.getObjectTypeBySid(parseInt(f, 10))) || o.is_family || !this.runtime.typeHasPersistBehavior(o)) continue;
				for (t = 0, s = (g = this.persist_data[f]).length; t < s; t++) y = null,
				o.plugin.is_world && !(y = this.getLayerBySid(g[t].w.l)) || (l = this.runtime.createInstanceFromInit(o.default_instance, y, !1, 0, 0, !0), this.runtime.loadInstanceFromJSON(l, g[t]), _ = !0, e.push(l));
				cr.clearArray(g)
			}
			for (t = 0, s = this.layers.length; t < s; t++) this.layers[t].instances.sort(i),
			this.layers[t].zindices_stale = !0
		}
		for (_ && (this.runtime.ClearDeathRow(), this.runtime.refreshUidMap()), t = 0; t < e.length; t++) if ((l = e[t]).type.is_contained) for (u = l.get_iid(), n = 0, a = l.type.container.length; n < a; n++) p = l.type.container[n],
		l.type !== p && (p.instances.length > u ? l.siblings.push(p.instances[u]) : p.default_instance && (d = this.runtime.createInstanceFromInit(p.default_instance, l.layer, !0, l.x, l.y, !0), this.runtime.ClearDeathRow(), p.updateIIDs(), l.siblings.push(d), e.push(d)));
		for (t = 0, s = this.initial_nonworld.length; t < s; t++) c = this.initial_nonworld[t],
		(o = this.runtime.types_by_index[c[1]]).is_contained || (l = this.runtime.createInstanceFromInit(this.initial_nonworld[t], null, !0));
		if (this.runtime.changelayout = null, this.runtime.ClearDeathRow(), this.runtime.ctx && !this.runtime.isDomFree) for (t = 0, s = this.runtime.types_by_index.length; t < s; t++) ! (p = this.runtime.types_by_index[t]).is_family && p.instances.length && p.preloadCanvas2D && p.preloadCanvas2D(this.runtime.ctx);
		if (this.runtime.isLoadingState) cr.shallowAssignArray(this.runtime.fireOnCreateAfterLoad, e);
		else for (t = 0, s = e.length; t < s; t++) l = e[t],
	...
	t.prototype.createGlobalNonWorlds = function () {
		var t, e, i, r, n;
		for (t = 0, e = 0, i = this.initial_nonworld.length; t < i; t++) r = this.initial_nonworld[t],
		(n = this.runtime.types_by_index[r[1]]).global ? n.is_contained || this.runtime.createInstanceFromInit(r, null, !0) : (this.initial_nonworld[e] = r, e++);
		cr.truncateArray(this.initial_nonworld, e)
	},
	t.prototype.stopRunning = function () {
		var t, e, i, n, s, a, o;
		if (this.runtime.isLoadingState || this.runtime.trigger(cr.system_object.prototype.cnds.OnLayoutEnd, null), this.runtime.isEndingLayout = !0, cr.clearArray(this.runtime.system.waits), !this.first_visit) for (t = 0, e = this.layers.length; t < e; t++) for (this.layers[t].updateZIndices(), i = 0, n = (s = this.layers[t].instances).length; i < n; i++)(a = s[i]).type.global || this.runtime.typeHasPersistBehavior(a.type) && this.saveObjectToPersist(a);
		...
		for (t = 0, e = this.runtime.types_by_index.length; t < e; t++) if (! ((o = this.runtime.types_by_index[t]).global || o.plugin.is_world || o.plugin.singleglobal || o.is_family)) {
	...
	t.prototype.drawGL = function (t) {
		...
		if (n) if (0 === this.active_effect_types.length || 1 === this.active_effect_types.length && this.runtime.fullscreenScalingQuality) {
	...
	t.prototype.renderEffectChain = function (t, e, i, r) {
		...
		if (i) {
			for (u = 0, p = n.length; u < p; u++) R += t.getProgramBoxExtendHorizontal(n[u].shaderindex),
			N += t.getProgramBoxExtendVertical(n[u].shaderindex);
			var M = i.bbox;
			if (O = e.layerToCanvas(M.left, M.top, !0, !0), A = e.layerToCanvas(M.left, M.top, !1, !0), E = e.layerToCanvas(M.right, M.bottom, !0, !0), I = e.layerToCanvas(M.right, M.bottom, !1, !0), 0 !== B) {
			...
			S.right = E / v,
			S.bottom = 1 - I / b
		} else S.left = T.left = 0,
		S.top = T.top = 0,
		S.right = T.right = 1,
		S.bottom = T.bottom = 1;
		var G = i && (t.programUsesDest(n[0].shaderindex) || 0 !== R || 0 !== N || 1 !== i.opacity || i.type.plugin.must_predraw) || e && !i && 1 !== e.opacity;
		t.setAlphaBlend(),
		G && (y[m] || (y[m] = t.createEmptyTexture(v, b, this.runtime.linearSampling)), y[m].c2width === v && y[m].c2height === b || (t.deleteTexture(y[m]), y[m] = t.createEmptyTexture(v, b, this.runtime.linearSampling)), t.switchProgram(0), t.setRenderingToTexture(y[m]), f = b - k - (g = L - k), t.clearRect(C, f, P - C, g), i ? i.drawGL(t) : (t.setTexture(this.runtime.layer_tex), t.setOpacity(e.opacity), t.resetModelView(), t.translate( - w, -x), t.updateModelView(), t.quadTex(O, I, E, I, E, A, O, A, S)), T.left = T.top = 0, T.right = T.bottom = 1, i && (d = S.top, S.top = S.bottom, S.bottom = d), m = 1, _ = 0),
		t.setOpacity(1);
		var V = n.length - 1,
		z = t.programUsesCrossSampling(n[V].shaderindex) || !e && !i && !this.runtime.fullscreenScalingQuality,
		U = 0;
		for (u = 0, p = n.length; u < p; u++) {
			if (y[m] || (y[m] = t.createEmptyTexture(v, b, this.runtime.linearSampling)), y[m].c2width === v && y[m].c2height === b || (t.deleteTexture(y[m]), y[m] = t.createEmptyTexture(v, b, this.runtime.linearSampling)), t.switchProgram(n[u].shaderindex), U = n[u].index, t.programIsAnimated(n[u].shaderindex) && (this.runtime.redraw = !0), 0 != u || G) t.setProgramParameters(r, 1 / v, 1 / b, T.left, T.top, T.right, T.bottom, s, a, o, h, (o + c) / 2, (h + l) / 2, this.runtime.kahanTime.sum, i ? i.effect_params[U] : e ? e.effect_params[U] : this.effect_params[U]),
			t.setTexture(null),
			u !== V || z ? (t.setRenderingToTexture(y[m]), f = b - k - (g = L - k), t.clearRect(C, f, P - C, g)) : (i ? t.setBlend(i.srcBlend, i.destBlend) : e && t.setBlend(e.srcBlend, e.destBlend), t.setRenderingToTexture(r)),
			t.setTexture(y[_]),
			t.resetModelView(),
			t.translate( - w, -x),
			t.updateModelView(),
			t.quadTex(O, I, E, I, E, A, O, A, S),
			u !== V || z || t.setTexture(null);
			else {
				if (t.setRenderingToTexture(y[m]), f = b - k - (g = L - k), t.clearRect(C, f, P - C, g), i) {
					var X, q;
					...
					i.drawGL(t)
				} else t.setProgramParameters(r, 1 / v, 1 / b, 0, 0, 1, 1, s, a, o, h, (o + c) / 2, (h + l) / 2, this.runtime.kahanTime.sum, e ? e.effect_params[U] : this.effect_params[U]),
		...
		z && (t.switchProgram(0), i ? t.setBlend(i.srcBlend, i.destBlend) : e ? t.setBlend(e.srcBlend, e.destBlend) : this.runtime.fullscreenScalingQuality || (t.setSize(this.runtime.width, this.runtime.height), w = this.runtime.width / 2, x = this.runtime.height / 2, O = 0, A = 0, E = this.runtime.width, I = this.runtime.height), t.setRenderingToTexture(r), t.setTexture(y[_]), t.resetModelView(), t.translate( - w, -x), t.updateModelView(), i && 1 === n.length && !G ? t.quadTex(O, A, E, A, E, I, O, I, S) : t.quadTex(O, I, E, I, E, A, O, A, S), t.setTexture(null))
	},
	...
	t.prototype.saveToJSON = function () {
		...
		for (t = 0, e = this.effect_types.length; t < e; t++) r = this.effect_types[t],
		n.fx.push({
			name: r.name,
			active: r.active,
			params: this.effect_params[r.index]
		});
		for (t = 0, e = this.layers.length; t < e; t++) i = this.layers[t],
	...
	s.prototype.createInitialInstances = function () {
		...
		for (t = 0, i = 0, r = this.initial_instances.length; t < r; t++) {
			if (s = this.initial_instances[t], a = this.runtime.types_by_index[s[1]], o = !0, !this.runtime.typeHasPersistBehavior(a) || this.layout.first_visit) {
				...
				e.push(n),
				n.type.global && (o = !1, this.created_globals.push(n.uid))
			}
	...
	s.prototype.recreateInitialObjects = function (t, e) {
		...
		f = t.is_family,
		g = t.members;
		for (i = 0, r = this.initial_instances.length; i < r; ++i) if (o = (a = (n = this.initial_instances[i])[0])[0], h = a[1], e.contains_pt(o, h)) {
			if ((s = d[n[1]]) !== t) {
				if (!f) continue;
				if (g.indexOf(s) < 0) continue
			}
			if (c = this.runtime.createInstanceFromInit(n, this, !1), this.runtime.isInOnDestroy++, this.runtime.trigger(Object.getPrototypeOf(s.plugin).cnds.OnCreated, c), c.is_contained) for (l = 0, u = c.siblings.length; l < u; l++) p = c.siblings[i],
	...
	s.prototype.setZIndicesStaleFrom = function (t) { - 1 === this.zindices_stale_from ? this.zindices_stale_from = t: t < this.zindices_stale_from && (this.zindices_stale_from = t),
	...
	s.prototype.updateZIndices = function () {
		if (this.zindices_stale) {
			var t, e, i;
			if ( - 1 === this.zindices_stale_from && (this.zindices_stale_from = 0), this.useRenderCells) for (t = this.zindices_stale_from, e = this.instances.length; t < e; ++t)(i = this.instances[t]).zindex = t,
			this.render_grid.markRangeChanged(i.rendercells);
			else for (t = this.zindices_stale_from, e = this.instances.length; t < e; ++t) this.instances[t].zindex = t;
			this.zindices_stale = !1,
			this.zindices_stale_from = -1
		}
	},
	...
	function c(t, e, i) {
		...
		h = t.length,
		c = e.length;
		for (i.length = h + c; s < h && a < c; ++o) r = t[s],
		n = e[a],
		r.zindex < n.zindex ? (i[o] = r, ++s) : (i[o] = n, ++a);
		for (; s < h; ++s, ++o) i[o] = t[s];
		for (; a < c; ++a, ++o) i[o] = e[a]
	}
	var l = [];
	function u(t, e) {
		var i, r, n, s, a;
		for (i = 0, r = t.length; i < r - 1; i += 2) c(n = t[i], s = t[i + 1], a = o()),
		e || (h(n), h(s)),
		l.push(a);
		r % 2 == 1 && (e ? (n = o(), cr.shallowAssignArray(n, t[r - 1]), l.push(n)) : l.push(t[r - 1])),
	...
	s.prototype.draw = function (t) {
		...
		this.transparent || (i.fillStyle = "rgb(" + this.background_color[0] + "," + this.background_color[1] + "," + this.background_color[2] + ")", i.fillRect(0, 0, this.runtime.draw_width, this.runtime.draw_height)),
		i.save(),
		this.disableAngle = !0;
		var n = this.canvasToLayer(0, 0, !0, !0),
		s = this.canvasToLayer(0, 0, !1, !0);
		this.disableAngle = !1,
		this.runtime.pixel_rounding && (n = Math.round(n), s = Math.round(s)),
		...
		i.restore(),
		this.render_offscreen && (t.globalCompositeOperation = this.compositeOp, t.globalAlpha = this.opacity, t.drawImage(e, 0, 0))
	},
	...
	s.prototype.rotateViewport = function (t, e, i) {
		...
		this.viewLeft > this.viewRight && (r = this.viewLeft, this.viewLeft = this.viewRight, this.viewRight = r),
		this.viewTop > this.viewBottom && (r = this.viewTop, this.viewTop = this.viewBottom, this.viewBottom = r);
		var s = this.getAngle();
	...
	s.prototype.drawGL_earlyZPass = function (t) {
		...
		this.transparent || (this.clear_earlyz_index = this.runtime.earlyz_index++, t.setEarlyZIndex(this.clear_earlyz_index), t.setColorFillMode(1, 1, 1, 1), t.fullscreenQuad(), t.restoreEarlyZMode())
	},
	s.prototype.drawGL = function (t) {
		...
		this.transparent || (this.runtime.enableFrontToBack ? (t.setEarlyZIndex(this.clear_earlyz_index), t.setColorFillMode(this.background_color[0] / 255, this.background_color[1] / 255, this.background_color[2] / 255, 1), t.fullscreenQuad(), t.setTextureFillMode()) : t.clear(this.background_color[0] / 255, this.background_color[1] / 255, this.background_color[2] / 255, 1)),
		this.disableAngle = !0;
		...
		if (this.useRenderCells && (this.last_render_list = s), this.render_offscreen) if (e = this.active_effect_types.length ? this.active_effect_types[0].shaderindex: 0, i = this.active_effect_types.length ? this.active_effect_types[0].index: 0, 0 === this.active_effect_types.length || 1 === this.active_effect_types.length && !t.programUsesCrossSampling(e) && 1 === this.opacity) {
	...
	s.prototype.drawInstanceWithShadersGL = function (t, e) {
		...
		n = this.getScale();
		if (1 !== t.active_effect_types.length || e.programUsesCrossSampling(i) || e.programExtendsBox(i) || (t.angle || t.layer.getAngle()) && e.programUsesDest(i) || 1 !== t.opacity || t.type.plugin.must_predraw) this.layout.renderEffectChain(e, this, t, this.render_offscreen ? this.runtime.layer_tex: this.layout.getRenderTarget()),
		e.resetModelView(),
		e.scale(n, n),
	...
	s.prototype.canvasToLayer = function (t, e, i, r) {
		...
		l = h,
		u = 1 / this.getScale(!r);
		r ? (c -= this.runtime.draw_width * u / 2, l -= this.runtime.draw_height * u / 2) : (c -= this.runtime.width * u / 2, l -= this.runtime.height * u / 2),
		c += t * u,
		l += e * u;
		var p = this.getAngle();
		if (0 !== p) {
	...
	s.prototype.layerToCanvas = function (t, e, i, r) {
		...
		r ? (h -= this.runtime.draw_width * f / 2, c -= this.runtime.draw_height * f / 2) : (h -= this.runtime.width * f / 2, c -= this.runtime.height * f / 2),
		h = (t - h) / f,
		c = (e - c) / f;
		var g = this.runtime.devicePixelRatio;
		return this.runtime.isRetina && !r && (h /= g, c /= g),
		i ? h: c
	},
	...
	s.prototype.saveToJSON = function () {
		...
		for (t = 0, e = this.effect_types.length; t < e; t++) i = this.effect_types[t],
		r.fx.push({
			name: i.name,
			active: i.active,
...
function () {
	...
	function e(t, e) {
		...
		default:
			for (i = 0; i < r; i++) if (t[i] !== e[i]) return ! 1;
			return ! 0
		}
	}
	function i(t, e) {
	...
	function r(r) {
		var n, s, a, o, h;
		for (2 === r.length ? r[0].index > r[1].index && (o = r[0], r[0] = r[1], r[1] = o) : r.length > 2 && r.sort(i), r.length >= t.length && (t.length = r.length + 1), t[r.length] || (t[r.length] = []), n = 0, s = (h = t[r.length]).length; n < s; n++) if (e(r, a = h[n])) return a;
		return h.push(r),
		r
	}
	function n(t, e) {
	...
	function a(t, e, i) {
		...
		i[1] && (this.group_name = i[1][1].toLowerCase(), this.group = !0, this.initially_activated = !!i[1][0], this.contained_includes = [], this.group_active = this.initially_activated, this.runtime.allGroups.push(this), this.runtime.groups_by_name[this.group_name] = this),
		this.orblock = i[2],
		this.sid = i[4],
		...
		this.conditions.length && (this.is_else_block = null == this.conditions[0].type && this.conditions[0].func == cr.system_object.prototype.cnds.
		Else)
	}
	function o(t, e) {
		var i, r, n;
		if (t && ( - 1 === e.indexOf(t) && e.push(t), t.is_contained)) for (i = 0, r = t.container.length; i < r; i++) t !== (n = t.container[i]) && -1 === e.indexOf(n) && e.push(n)
	}
	function h(t, e) {
		if (this.block = t, this.sheet = t.sheet, this.runtime = t.runtime, this.parameters = [], this.results = [], this.extra = {},
	...
	n.prototype.init_event = function (t, e, i) {
		...
		case 0:
			...
			if (cr.seal(s), s.orblock) for (i.push(s), r = 0, n = s.conditions.length; r < n; r++) s.conditions[r].trigger && this.init_trigger(s, r);
	...
	n.prototype.addDeepIncludes = function (t) {
		...
		for (e = 0, i = o.length; e < i; ++e) n = (r = o[e]).include_sheet,
		!r.isActive() || t === n || a.indexOf(n) > -1 || (a.push(n), n.addDeepIncludes(t), s.push(n))
	},
	...
	n.prototype.init_trigger = function (t, e) {
		...
		if (n) {
			...
			for (l = 0, u = a.length; l < u; l++) if (a[l].method == o) return void((h = a[l].evs)[p] ? h[p].push([t, e]) : h[p] = [[t, e]]);
			(h = {})[p] = [[t, e]],
			a.push({
				method: o,
				evs: h
			...
			for (l = 0, u = a.length; l < u; l++) if (a[l].method == o) return void a[l].evs.push([t, e]); !
			function (t) {
	...
	a.prototype.postInit = function (t) {
		...
		if (this.group) for (this.toplevelgroup = !0; n;) {
			if (!n.group) {
				this.toplevelgroup = !1;
				break
			}
	...
	a.prototype.run = function () {
		...
		if (this.is_else_block || (n.else_branch_ran = !1), this.orblock) {
			...
			for (n.cndindex = 0, t = s.length; n.cndindex < t; n.cndindex++) if (!s[n.cndindex].run()) return n.last_event_true = !1,
	...
	a.prototype.run_orblocktrigger = function (t) {
		...
		this.conditions[t].run() && (this.run_actions_and_subevents(), this.runtime.getCurrentEventStack().last_event_true = !0)
	},
	...
	a.prototype.run_subevents = function () {
		if (this.subevents.length) {
			...
			if (this.runtime.pushEventStack(this), this.solWriterAfterCnds) for (t = 0, e = this.subevents.length; t < e; t++) i = this.subevents[t],
			...
			else for (t = 0, e = this.subevents.length; t < e; t++) this.subevents[t].run();
	...
	a.prototype.run_pretrigger = function () {
		...
		var e, i = !1;
		for (t.cndindex = 0, e = this.conditions.length; t.cndindex < e; t.cndindex++) if (this.conditions[t.cndindex].run()) i = !0;
	...
	a.prototype.retrigger = function () {
		...
		if (!this.orblock) for (i.cndindex = e + 1, t = this.conditions.length; i.cndindex < t; i.cndindex++) if (!this.conditions[i.cndindex].run()) return this.runtime.popEventStack(),
		!1;
	...
	h.prototype.postInit = function () {
		var t, e, i;
		for (t = 0, e = this.parameters.length; t < e; t++)(i = this.parameters[t]).postInit(),
	...
	h.prototype.run_object = function () {
		...
		T = this.inverted,
		O = this.func;
		if (w) for (e = 0, n = x.length; e < n; ++e)(s = x[e]).variesPerInstance || (S[e] = s.get(0));
		else for (e = 0, n = x.length; e < n; ++e) S[e] = x[e].get(0);
		if (d.select_all) {
			for (cr.clearArray(d.instances), cr.clearArray(d.else_instances), t = 0, r = (l = p.instances).length; t < r; ++t) {
				if (o = l[t], w) for (e = 0, n = x.length; e < n; ++e)(s = x[e]).variesPerInstance && (S[e] = s.get(t));
				b ? (g = 0, m && (g = o.type.family_beh_map[_]), a = O.apply(o.behavior_insts[v + g], S)) : a = O.apply(o, S),
		...
		for (t = 0, r = (l = C ? d.else_instances: d.instances).length; t < r; ++t) {
			if (o = l[t], w) for (e = 0, n = x.length; e < n; ++e)(s = x[e]).variesPerInstance && (S[e] = s.get(t));
			if (b ? (g = 0, m && (g = o.type.family_beh_map[_]), a = O.apply(o.behavior_insts[v + g], S)) : a = O.apply(o, S), cr.xor(a, T)) if (A = !0, C) {
				if (d.instances.push(o), y) for (e = 0, n = o.siblings.length; e < n; e++)(h = o.siblings[e]).type.getCurrentSol().instances.push(h)
			} else {
				if (l[i] = o, y) for (e = 0, n = o.siblings.length; e < n; e++)(h = o.siblings[e]).type.getCurrentSol().instances[i] = h;
				i++
			} else if (C) {
				if (l[i] = o, y) for (e = 0, n = o.siblings.length; e < n; e++)(h = o.siblings[e]).type.getCurrentSol().else_instances[i] = h;
				i++
			} else if (f && (d.else_instances.push(o), y)) for (e = 0, n = o.siblings.length; e < n; e++)(h = o.siblings[e]).type.getCurrentSol().else_instances.push(h)
		}
		if (cr.truncateArray(l, i), y) for (t = 0, r = (u = p.container).length; t < r; t++) c = u[t].getCurrentSol(),
		C ? cr.truncateArray(c.else_instances, i) : cr.truncateArray(c.instances, i);
		var k = A;
		if (C && !A) for (t = 0, r = d.instances.length; t < r; t++) {
			if (o = d.instances[t], w) for (e = 0, n = x.length; e < n; e++)(s = x[e]).variesPerInstance && (S[e] = s.get(t));
	...
	c.prototype.run_object = function () {
		...
		g = o.is_family,
		y = h > -1;
		if (l) for (e = 0, r = u.length; e < r; ++e)(n = u[e]).variesPerInstance || (p[e] = n.get(0));
		else for (e = 0, r = u.length; e < r; ++e) p[e] = u[e].get(0);
		for (t = 0, i = f.length; t < i; ++t) {
			if (s = f[t], l) for (e = 0, r = u.length; e < r; ++e)(n = u[e]).variesPerInstance && (p[e] = n.get(t));
	...
	function f(t, e) {
		...
		case 10:
			this.index = e[1],
			t.type && t.type.is_family ? (this.get = this.get_familyvar, this.variesPerInstance = !0) : this.get = this.get_instvar;
			break;
		case 11:
			this.varname = e[1],
			this.eventvar = null,
		...
		case 12:
			...
			break;
		case 13:
			for (this.get = this.get_variadic, this.subparams = [], this.variadicret = [], i = 1, r = e.length; i < r; i++) n = new cr.parameter(this.owner, e[i]),
			cr.seal(n),
	...
	function g(t, e, i) {
		...
		this.parent ? (this.is_static || this.is_constant ? this.localIndex = -1 : this.localIndex = this.runtime.stackLocalCount++, this.runtime.all_local_vars.push(this)) : (this.localIndex = -1, this.runtime.all_global_vars.push(this))
	}
	function y(t, e, i) {
		this.sheet = t,
		this.parent = e,
	...
	f.prototype.postInit = function () {
		...
		else if (13 === this.type) for (t = 0, e = this.subparams.length; t < e; t++) this.subparams[t].postInit();
	...
	g.prototype.run = function () { ! this.parent || this.is_static || this.is_constant || this.setValue(this.initial)
	},
	cr.eventvariable = g,
	...
	y.prototype.postInit = function () {
		...
		this.solModifiers = r(this.solModifiers);
		for (var t = this.parent; t;) t.group && t.contained_includes.push(this),
		t = t.parent;
		this.updateActive()
	},
...
function () {
	function t(t, e) {
		...
		case 19:
			...
			this.results = [],
			this.parameters = [],
			3 === e.length ? (n = e[2], this.results.length = n.length + 1) : this.results.length = 1;
			break;
		case 20:
			...
			this.results = [],
			this.parameters = [],
			6 === e.length ? (n = e[5], this.results.length = n.length + 1) : this.results.length = 1;
			break;
		case 21:
			this.object_type = this.runtime.types_by_index[e[1]],
		...
		case 22:
			...
			this.results = [],
			this.parameters = [],
			7 === e.length ? (n = e[6], this.results.length = n.length + 1) : this.results.length = 1;
			break;
		case 23:
			this.varname = e[1],
			this.eventvar = null
		}
		if (this.owner.maybeVaryForType(this.object_type), this.type >= 4 && this.type <= 17 && (this.first = new cr.expNode(t, e[1]), this.second = new cr.expNode(t, e[2])), n) for (i = 0, r = n.length; i < r; i++) this.parameters.push(new cr.expNode(t, n[i]));
		cr.seal(this)
	}
	t.prototype.postInit = function () {
		var t, e;
		if (23 === this.type && (this.eventvar = this.owner.runtime.getEventVariableByName(this.varname, this.owner.block.parent)), this.first && this.first.postInit(), this.second && this.second.postInit(), this.third && this.third.postInit(), this.instance_expr && this.instance_expr.postInit(), this.parameters) for (t = 0, e = this.parameters.length; t < e; t++) this.parameters[t].postInit()
	};
	var e = [],
	i = -1;
	function r() {
	...
	function s(t, e, i) {
		var r, n;
		for (r = 0, n = t.length; r < n; ++r) t[r].get(i),
		e[r + 1] = i.data
	}
	function a(t, e) {
	...
	t.prototype.eval_object_exp = function (t) {
		...
		var p = r();
		s(a, i, p),
		o && (o.get(p), p.is_number() && (c = p.data, u = e.instances)),
		n();
		var d = u.length;
		(c >= d || c <= -d) && (c %= d),
		c < 0 && (c += d);
	...
	t.prototype.eval_behavior_exp = function (t) {
		...
		var d = r();
		s(a, i, d),
		o && (o.get(d), d.is_number() && (l = d.data, p = e.instances)),
		n();
		var f = p.length;
		(l >= f || l <= -f) && (l %= f),
		l < 0 && (l += f);
	...
	t.prototype.eval_add = function (t) {
		...
		var e = r();
		this.second.get(e),
		t.is_number() && e.is_number() && (t.data += e.data, e.is_float() && t.make_float()),
		n()
	},
	...
	t.prototype.eval_divide = function (t) {
		...
		var e = r();
		this.second.get(e),
		t.is_number() && e.is_number() && (t.data /= e.data, t.make_float()),
		n()
	},
	...
	t.prototype.eval_power = function (t) {
		...
		var e = r();
		this.second.get(e),
		t.is_number() && e.is_number() && (t.data = Math.pow(t.data, e.data), e.is_float() && t.make_float()),
		n()
	},
...
cr.system_object.prototype.saveToJSON = function () {
	...
	for (t = 0, e = this.waits.length; t < e; t++) {
		...
		for (n in s.sols) if (s.sols.hasOwnProperty(n)) {
...
cr.system_object.prototype.loadFromJSON = function (t) {
	...
	for (cr.clearArray(this.waits), e = 0, i = f.length; e < i; e++) if (a = f[e], h = this.runtime.blocksBySid[a.ev.toString()]) {
		for (c = -1, r = 0, n = h.actions.length; r < n; r++) if (h.actions[r].sid === a.act) {
			c = r;
			break
		}
		if ( - 1 !== c) {
			for ((o = {}).sols = {},
			o.solModifiers = [], o.deleteme = !1, o.time = a.t, o.signaltag = a.st || "", o.signalled = !!a.s, o.ev = h, o.actindex = c, r = 0, n = a.sm.length; r < n; r++)(l = this.runtime.getObjectTypeBySid(a.sm[r])) && o.solModifiers.push(l);
			for (s in a.sols) if (a.sols.hasOwnProperty(s)) {
...
function () {
	...
	e.prototype.Repeat = function (t) {
		...
		if (n) for (e = 0; e < t && !s.stopped; e++) this.runtime.pushCopySol(r.solModifiers),
		s.index = e,
		r.retrigger(),
		this.runtime.popSol(r.solModifiers);
		else for (e = 0; e < t && !s.stopped; e++) s.index = e,
		r.retrigger();
	...
	e.prototype.While = function (t) {
		...
		n = i.isModifierAfterCnds(),
		s = this.runtime.pushLoopStack();
		if (n) for (e = 0; ! s.stopped; e++) this.runtime.pushCopySol(r.solModifiers),
		s.index = e,
		r.retrigger() || (s.stopped = !0),
		this.runtime.popSol(r.solModifiers);
		else for (e = 0; ! s.stopped; e++) s.index = e,
		r.retrigger() || (s.stopped = !0);
		return this.runtime.popLoopStack(),
		!1
	},
	e.prototype.For = function (t, e, i) {
		...
		if (i < e) if (a) for (r = e; r >= i && !o.stopped; --r) this.runtime.pushCopySol(s.solModifiers),
		o.index = r,
		s.retrigger(),
		this.runtime.popSol(s.solModifiers);
		else for (r = e; r >= i && !o.stopped; --r) o.index = r,
		s.retrigger();
		else if (a) for (r = e; r <= i && !o.stopped; ++r) this.runtime.pushCopySol(s.solModifiers),
		o.index = r,
		s.retrigger(),
		this.runtime.popSol(s.solModifiers);
		else for (r = e; r <= i && !o.stopped; ++r) o.index = r,
	...
	e.prototype.ForEach = function (t) {
		...
		y = t.is_contained;
		if (f) for (s = 0, a = n.length; s < a && !g.stopped; s++) {
			if (this.runtime.pushCopySol(d.solModifiers), c = n[s], (e = t.getCurrentSol()).select_all = !1, cr.clearArray(e.instances), e.instances[0] = c, y) for (o = 0, h = c.siblings.length; o < h; o++)(u = (l = c.siblings[o]).type.getCurrentSol()).select_all = !1,
			cr.clearArray(u.instances),
			u.instances[0] = l;
			g.index = s,
			d.retrigger(),
			this.runtime.popSol(d.solModifiers)
		} else for (e.select_all = !1, cr.clearArray(e.instances), s = 0, a = n.length; s < a && !g.stopped; s++) {
			if (c = n[s], e.instances[0] = c, y) for (o = 0, h = c.siblings.length; o < h; o++)(u = (l = c.siblings[o]).type.getCurrentSol()).select_all = !1,
			cr.clearArray(u.instances),
			u.instances[0] = l;
			g.index = s,
			d.retrigger()
	...
	e.prototype.ForEachOrdered = function (t, e, s) {
		...
		if (_) for (h = 0, c = o.length; h < c && !v.stopped; h++) {
			if (this.runtime.pushCopySol(y.solModifiers), p = o[h], (a = t.getCurrentSol()).select_all = !1, cr.clearArray(a.instances), a.instances[0] = p, b) for (l = 0, u = p.siblings.length; l < u; l++)(f = (d = p.siblings[l]).type.getCurrentSol()).select_all = !1,
			cr.clearArray(f.instances),
			f.instances[0] = d;
			v.index = h,
			y.retrigger(),
			this.runtime.popSol(y.solModifiers)
		} else for (a.select_all = !1, cr.clearArray(a.instances), h = 0, c = o.length; h < c && !v.stopped; h++) {
			if (p = o[h], a.instances[0] = p, b) for (l = 0, u = p.siblings.length; l < u; l++)(f = (d = p.siblings[l]).type.getCurrentSol()).select_all = !1,
			cr.clearArray(f.instances),
			f.instances[0] = d;
			v.index = h,
			y.retrigger()
	...
	e.prototype.PickByComparison = function (t, e, n, s) {
		...
		if (t) {
			...
			for (a = 0, h = 0, o = l.length; a < o; a++) c = l[a],
			l[h] = c,
	...
	e.prototype.PickByEvaluate = function (t, e) {
		...
		if (t) {
			...
			for (n = 0, a = 0, s = h.length; n < s; n++) o = h[n],
			h[a] = o,
	...
	o = "";
	function h(t, e) {
		return s && t === a && e === o || (s = new RegExp(t, e), a = t, o = e),
		s.lastIndex = 0,
		s
	}
	...
	e.prototype.PickOverlappingPoint = function (t, e, i) {
		...
		for (a.select_all ? (cr.shallowAssignArray(c, o), cr.clearArray(a.else_instances), a.select_all = !1, cr.clearArray(a.instances)) : h ? (cr.shallowAssignArray(c, a.else_instances), cr.clearArray(a.else_instances)) : (cr.shallowAssignArray(c, o), cr.clearArray(a.instances)), r = 0, n = c.length; r < n; ++r)(s = c[r]).update_bbox(),
	...
	l.prototype.CreateObject = function (t, e, i, r) {
		if (e && t) {
			...
			if (n) {
				var s, a, o;
				if (this.runtime.isInOnDestroy++, this.runtime.trigger(Object.getPrototypeOf(t.plugin).cnds.OnCreated, n), n.is_contained) for (s = 0, a = n.siblings.length; s < a; s++) o = n.siblings[s],
				this.runtime.trigger(Object.getPrototypeOf(o.type.plugin).cnds.OnCreated, o);
				this.runtime.isInOnDestroy--;
				var h = t.getCurrentSol();
				if (h.select_all = !1, cr.clearArray(h.instances), h.instances[0] = n, n.is_contained) for (s = 0, a = n.siblings.length; s < a; s++)(h = (o = n.siblings[s]).type.getCurrentSol()).select_all = !1,
	...
	l.prototype.SetLayoutAngle = function (t) {
		t = cr.to_radians(t),
		t = cr.clamp_angle(t),
		this.runtime.running_layout && this.runtime.running_layout.angle !== t && (this.runtime.running_layout.angle = t, this.runtime.redraw = !0)
	},
	...
	l.prototype.GoToLayoutByName = function (t) {
		var e;
		if (!this.runtime.isloading && !this.runtime.changelayout) for (e in this.runtime.layouts) if (this.runtime.layouts.hasOwnProperty(e) && cr.equals_nocase(e, t)) return void(this.runtime.changelayout = this.runtime.layouts[e])
	},
	l.prototype.RestartLayout = function (t) {
		var e, i, r;
		if (!this.runtime.isloading && (!this.runtime.changelayout && this.runtime.running_layout)) for (this.runtime.changelayout = this.runtime.running_layout, e = 0, i = this.runtime.allGroups.length; e < i; e++)(r = this.runtime.allGroups[e]).setGroupActive(r.initially_activated)
	},
	...
	l.prototype.SetCanvasSize = function (t, e) {
		if (! (t <= 0 || e <= 0)) {
			...
			0 === i ? this.runtime.setSize(t, e, !0) : (this.runtime.original_width = t, this.runtime.original_height = e, this.runtime.setSize(this.runtime.lastWindowWidth, this.runtime.lastWindowHeight, !0))
		}
	},
	...
	l.prototype.SetFullscreenQuality = function (t) { (document.mozFullScreen || document.webkitIsFullScreen || !!document.msFullscreenElement || document.fullScreen || this.isNodeFullscreen || 0 !== this.runtime.fullscreen_mode) && (this.runtime.wantFullscreenScalingQuality = 0 !== t, this.runtime.setSize(this.runtime.lastWindowWidth, this.runtime.lastWindowHeight, !0))
	},
	l.prototype.ResetPersisted = function () {
		var t, e;
		for (t = 0, e = this.runtime.layouts_by_index.length; t < e; ++t) this.runtime.layouts_by_index[t].persist_data = {},
	...
	l.prototype.SortZOrderByInstVar = function (t, e) {
		if (t) {
			...
			if (c.length) for (c.sort(m), l.sort(_), i = 0, r = c.length; i < r; ++i) n = l[i][0],
			a = u.layers[c[i][0]],
			o = c[i][1],
			a.instances[o] !== n && (a.instances[o] = n, n.layer = a, a.setZIndicesStaleFrom(o))
		}
	},
	t.acts = new l,
	...
	v.prototype.loopindex = function (t, e) {
		var i, r;
		if (this.runtime.loop_stack.length) if (e) {
			for (r = this.runtime.loop_stack_index; r >= 0; --r) if ((i = this.runtime.loop_stack[r]).name === e) return void t.set_int(i.index);
			t.set_int(0)
		} else i = this.runtime.getCurrentLoop(),
	...
	t.runWaits = function () {
		...
		for (t = 0, e = 0, i = this.waits.length; t < i; t++) r = this.waits[t],
		this.waits[e] = r,
		r.deleteme ? d(r) : e++;
...
function () {
	cr.add_common_aces = function (t, e) {
		...
		c.PickDistance = function (t, e, i) {
			...
			for (s = 1, a = n.length; s < a; s++) h = n[s],
		...
		c.PickInstVarHiLow = function (t, e) {
			...
			h = o,
			c = o.instance_vars[e];
			for (n = 1, s = r.length; n < s; n++) a = (o = r[n]).instance_vars[e],
			(0 === t && a < c || 1 === t && a > c) && (c = a, h = o);
			return i.pick_one(h),
			!0
		},
		c.PickByUID = function (t) {
			...
			if (this.runtime.getCurrentCondition().inverted) {
				...
				for (e = 0, r = 0, i = o.instances.length; e < i; e++) n = o.instances[e],
				o.instances[r] = n,
			...
			if (this.is_family) {
				for (e = 0, i = (s = n.type.families).length; e < i; e++) if (s[e] === this) return o.pick_one(n),
				this.applySolToContainer(),
				!0
			} else if (n.type === this) return o.pick_one(n),
			this.applySolToContainer(),
			!0;
			return ! 1
		},
		...
		l.LoadFromJsonString || (l.LoadFromJsonString = function (t) {
			...
			if (this.runtime.loadInstanceFromJSON(this, e, !0), this.afterLoad && this.afterLoad(), this.behavior_insts) for (i = 0, r = this.behavior_insts.length; i < r; ++i)(n = this.behavior_insts[i]).afterLoad && n.afterLoad()
		}), u.Count = function (t) {
			var e, i, r, n = t.object_class.instances.length;
			for (e = 0, i = this.runtime.createRow.length; e < i; e++) r = this.runtime.createRow[e],
		...
		l.SetVisible = function (t) { ! t != !this.visible && (this.visible = !!t, this.runtime.redraw = !0)
		},
		...
		l.SetOpacity = function (t) {
			var e = t / 100;
			e < 0 ? e = 0 : e > 1 && (e = 1),
			e !== this.opacity && (this.opacity = e, this.runtime.redraw = !0)
		},
		...
		c.PickTopBottom = function (t) {
			...
			var r, n, s = i[0],
			a = s;
			for (r = 1, n = i.length; r < n; r++) s = i[r],
	...
	cr.update_bbox = function () {
		if (this.bbox_changed) {
			...
			this.angle ? (t.offset( - this.x, -this.y), e.set_from_rotated_rect(t, this.angle), e.offset(this.x, this.y), e.bounding_box(t)) : e.set_from_rect(t),
			t.normalize(),
			this.bbox_changed = !1,
	...
	cr.update_render_cell = function () {
		if (this.layer.useRenderCells) {
			...
			this.rendercells.equals(t) || (this.rendercells.right < this.rendercells.left ? e.update(this, null, t) : e.update(this, this.rendercells, t), this.rendercells.copy(t), this.layer.render_list_stale = !0)
		}
	},
	cr.update_collision_cell = function () {
		if (this.cell_changed && this.collisionsEnabled) {
			...
			i = this.bbox;
			t.set(e.XToCell(i.left), e.YToCell(i.top), e.XToCell(i.right), e.YToCell(i.bottom)),
			this.collcells.equals(t) || (this.collcells.right < this.collcells.left ? e.update(this, null, t) : e.update(this, this.collcells, t), this.collcells.copy(t), this.cell_changed = !1)
		}
	},
	...
	cr.type_getFirstPicked = function (t) {
		var e, i, r;
		if (t && t.is_contained && t.type != this) for (e = 0, i = t.siblings.length; e < i; e++) if ((r = t.siblings[e]).type == this) return r;
	...
	cr.type_getInstanceByIID = function (t) {
		...
		for (e = 0, i = r.length; e < i; ++e) if (r[e].type === this) {
			if (0 === t) return r[e]; --t
		}
		return null
	},
	...
	cr.type_getBehaviorByName = function (t) {
		var e, i, r, n, s, a = 0;
		if (!this.is_family) for (e = 0, i = this.families.length; e < i; e++) for (r = 0, n = (s = this.families[e]).behaviors.length; r < n; r++) {
			if (t === s.behaviors[r].name) return this.extra.lastBehIndex = a,
			s.behaviors[r];
			a++
		}
		for (e = 0, i = this.behaviors.length; e < i; e++) {
			if (t === this.behaviors[e].name) return this.extra.lastBehIndex = a,
			this.behaviors[e];
			a++
		}
		return null
	...
	cr.type_applySolToContainer = function () {
		if (this.is_contained && !this.is_family) {
			...
			for (t = 0, e = this.container.length; t < e; t++) if ((n = this.container[t]) !== this && (n.updateIIDs(), (a = n.getCurrentSol()).select_all = o, !o)) {
				for (cr.clearArray(a.instances), i = 0, r = s.instances.length; i < r; ++i) a.instances[i] = n.getInstanceByIID(s.instances[i].iid);
				if (c) for (cr.clearArray(a.else_instances), i = 0, r = s.else_instances.length; i < r; ++i) a.else_instances[i] = n.getInstanceByIID(s.else_instances[i].iid)
			}
		}
	},
...
function () {
	...
	e.onCreate = function () {
		...
		for (n.length = this.cx, t = 0; t < this.cx; t++) for (n[t] || (n[t] = r()), n[t].length = this.cy, e = 0; e < this.cy; e++) for (n[t][e] || (n[t][e] = r()), n[t][e].length = this.cz, i = 0; i < this.cz; i++) n[t][e][i] = 0;
		this.forX = [],
		this.forY = [],
		this.forZ = [],
		this.forDepth = -1
	...
	e.setSize = function (t, e, i) {
		if (t < 0 && (t = 0), e < 0 && (e = 0), i < 0 && (i = 0), this.cx !== t || this.cy !== e || this.cz !== i) {
			...
			this.cz = i;
			var o = this.arr;
			for (o.length = t, n = 0; n < this.cx; n++) for (cr.is_undefined(o[n]) && (o[n] = r()), o[n].length = e, s = 0; s < this.cy; s++) for (cr.is_undefined(o[n][s]) && (o[n][s] = r()), o[n][s].length = i, a = 0; a < this.cz; a++) cr.is_undefined(o[n][s][a]) && (o[n][s][a] = 0)
		}
	},
	e.getForX = function () {
	...
	s.prototype.Contains = function (t) {
		var e, i, r;
		for (e = 0; e < this.cx; e++) for (i = 0; i < this.cy; i++) for (r = 0; r < this.cz; r++) if (this.arr[e][i][r] === t) return ! 0;
		return ! 1
	},
	s.prototype.IsEmpty = function () {
	...
	a.prototype.Push = function (t, e, i) {
		...
		switch (i) {
		case 0:
			for (0 === t ? (n = o.length, o.push(r())) : (n = 0, o.unshift(r())), o[n].length = this.cy; s < this.cy; s++) for (o[n][s] = r(), o[n][s].length = this.cz, a = 0; a < this.cz; a++) o[n][s][a] = e;
			this.cx++;
			break;
		case 1:
			for (; n < this.cx; n++) for (0 === t ? (s = o[n].length, o[n].push(r())) : (s = 0, o[n].unshift(r())), o[n][s].length = this.cz, a = 0; a < this.cz; a++) o[n][s][a] = e;
			this.cy++;
			break;
		case 2:
			for (; n < this.cx; n++) for (s = 0; s < this.cy; s++) 0 === t ? o[n][s].push(e) : o[n][s].unshift(e);
			this.cz++
		}
	},
	a.prototype.Pop = function (t, e) {
		...
		case 2:
			if (0 === this.cz) break;
			for (; i < this.cx; i++) for (r = 0; r < this.cy; r++) 0 === t ? s[i][r].pop() : s[i][r].shift();
			this.cz--
		}
	},
	a.prototype.Reverse = function (t) {
		...
		case 1:
			...
			break;
		case 2:
			for (; e < this.cx; e++) for (i = 0; i < this.cy; i++) r[e][i].reverse()
		}
	},
	a.prototype.Sort = function (t) {
		...
		case 1:
			...
			break;
		case 2:
			for (; e < this.cx; e++) for (i = 0; i < this.cy; i++) r[e][i].sort(o)
		}
	},
	a.prototype.Delete = function (t, e) {
		...
		case 1:
			if (t >= this.cy) break;
			for (; i < this.cx; i++) n(s[i][t]),
			s[i].splice(t, 1);
			this.cy--;
			break;
		case 2:
			if (t >= this.cz) break;
			for (; i < this.cx; i++) for (r = 0; r < this.cy; r++) s[i][r].splice(t, 1);
			this.cz--
		}
	},
	a.prototype.Insert = function (t, e, i) {
		...
		case 0:
			if (e > this.cx) return;
			for (n = e, o.splice(n, 0, r()), o[n].length = this.cy; s < this.cy; s++) for (o[n][s] = r(), o[n][s].length = this.cz, a = 0; a < this.cz; a++) o[n][s][a] = t;
			this.cx++;
			break;
		case 1:
			if (e > this.cy) return;
			for (; n < this.cx; n++) for (s = e, o[n].splice(s, 0, r()), o[n][s].length = this.cz, a = 0; a < this.cz; a++) o[n][s][a] = t;
			this.cy++;
			break;
		case 2:
			if (e > this.cz) return;
			for (; n < this.cx; n++) for (s = 0; s < this.cy; s++) o[n][s].splice(e, 0, t);
			this.cz++
		}
	},
...
function () {
	...
	P = !1,
	I = !1;
	function L(t) { - 1 === E.indexOf(t) && E.push(t)
	}
	function R(t) {
	...
	function N() {
		...
		var n = E.slice(0);
		if (cr.clearArray(E), !y) for (t = 0, e = n.length; t < e; ++t)(i = n[t]).stopped || i.is_paused || (r = i.instanceObject.play()) && r.
		catch(function (t) {
			L(i)
		})
	}
	...
	function X(t, e, i, r) {
		if (t) if (t.cancelScheduledValues(0), 0 !== r) {
			var n = l.currentTime;
			switch (r += n, i) {
			case 0:
	...
	function J(t, e, i, r) {
		...
		t && (this.convolveNode.normalize = e, this.convolveNode.buffer = t),
	...
	function st(t, i) {
		...
		case s:
			...
			c === a && l.createMediaElementSource && !/wiiu/i.test(navigator.userAgent) && (this.supportWebAudioAPI = !0, this.bufferObject.addEventListener("canplay", function () { ! n.mediaSourceNode && n.bufferObject && (n.mediaSourceNode = l.createMediaElementSource(n.bufferObject), n.mediaSourceNode.connect(n.outNode))
			})),
	...
	function at(t, u) {
		...
		this.onended_handler = function (t) {
			if (!p.is_paused && !p.resume_me) {
				var n = this;
				n || (n = t.target),
				n === p.active_buffer && (p.hasPlaybackEnded = !0, p.stopped = !0, r = p.tag, e.trigger(cr.plugins_.Audio.prototype.cnds.OnEnded, i))
			}
		},
		...
		case s:
			this.is_music ? (this.instanceObject = t.bufferObject, d = !t.added_end_listener, t.added_end_listener = !0) : (this.instanceObject = new Audio, this.instanceObject.crossOrigin = "anonymous", this.instanceObject.autoplay = !1, this.instanceObject.src = t.bufferObject.src, d = !0),
	...
	et.prototype.generateColortouchCurve = function (t, e) {
		for (var i = F(t), r = F(e), n = 32768, s = 0, a = 0; a < n; ++a) s = a / n,
		s = this.shape(s, i, r),
		this.curve[n + a] = s,
		this.curve[n - a - 1] = -s
	},
	...
	rt.prototype.tick = function () {
		...
		e = 0;
		this.peak = 0;
		for (var i = 0, r = 0; e < t; e++)(r = (this.signal[e] - 128) / 128) < 0 && (r = -r),
	...
	st.prototype.release = function () {
		var t, e, i, r;
		for (t = 0, i = 0, e = p.length; t < e; ++t) r = p[t],
		p[i] = r,
		r.buffer === this ? r.stop() : ++i;
		p.length = i,
		this.mediaSourceNode && (this.mediaSourceNode.disconnect(), this.mediaSourceNode = null),
		...
		if (!this.bufferObject && this.audioData) {
			...
			if (l.decodeAudioData) l.decodeAudioData(this.audioData, function (i) {
				...
				if (t.bufferObject = i, t.audioData = null, cr.is_undefined(t.playTagWhenReady) || y) {
					...
					for (n = 0, s = t.panWhenReady.length; n < s; n++) if (r = t.panWhenReady[n], (a = new at(t, r.thistag)).setPannerEnabled(!0), void 0 === r.objUid || (r.obj = e.getObjectByUID(r.objUid), r.obj)) {
						if (r.obj) {
				...
				} else(a = new at(t, t.playTagWhenReady || "")).play(t.loopWhenReady, t.volumeWhenReady, t.seekWhenReady),
				t.pauseWhenReady && a.pause(),
				p.push(a)
			},
			function (e) {
	...
	at.prototype.setPannerEnabled = function (t) {
		if (c === a) if (!this.pannerEnabled && t) {
			if (!this.gainNode) return;
			this.pannerNode || (this.pannerNode = l.createPanner(), "number" == typeof this.pannerNode.panningModel ? this.pannerNode.panningModel = w: this.pannerNode.panningModel = ["equalpower", "HRTF", "soundfield"][w], "number" == typeof this.pannerNode.distanceModel ? this.pannerNode.distanceModel = x: this.pannerNode.distanceModel = ["linear", "inverse", "exponential"][x], this.pannerNode.refDistance = S, this.pannerNode.maxDistance = T, this.pannerNode.rolloffFactor = O),
	...
	at.prototype.play = function (t, i, r, n) {
		...
		case s:
			...
			break;
		case a:
			if (this.muted = !1, this.mutevol = 1, this.buffer.myapi === a) this.gainNode.gain.value = i * m,
			this.fresh || (this.instanceObject = l.createBufferSource(), this.instanceObject.buffer = this.buffer.bufferObject, this.instanceObject.connect(this.gainNode)),
	...
	t.Instance = function (t) {
		...
		if (this.runtime.isSafari && this.runtime.isWindows && "undefined" == typeof Audio) alert("It looks like you're using Safari for Windows without Quicktime.  Audio cannot be played until Quicktime is installed."),
		this.runtime.DestroyInstance(this);
		else {
	...
	ot.saveToJSON = function () {
		...
		s = r.pan, i.objectTracker && i.objectTracker.hasObject() ? s.objUid = i.objectTracker.obj.uid: (s.x = i.panX, s.y = i.panY, s.a = i.panAngle), s.ia = i.panConeInner, s.oa = i.panConeOuter, s.og = i.panConeOuterGain), h.push(r)));
		var c, l = o.effects;
		for (n in j) if (j.hasOwnProperty(n)) {
	...
	ot.loadFromJSON = function (t) {
		...
		if (3 !== this.saveload) for (r = 0, n = p.length; r < n; r++)(f = p[r]).is_music && 1 === this.saveload || (f.is_music || 2 !== this.saveload) && f.stop();
		for (g in j) if (j.hasOwnProperty(g)) for (r = 0, n = j[g].length; r < n; r++) j[g][r].remove();
		for (g in cr.wipe(j), t.effects) if (t.effects.hasOwnProperty(g)) for (r = 0, n = (b = t.effects[g]).length; r < n; r++) switch (w = b[r].type, x = b[r].params, w) {
		case "filter":
		...
		case "convolve":
			a = x[2],
			(d = this.getAudioBuffer(a, !1)).bufferObject ? S = new J(d.bufferObject, x[0], x[1], a) : (S = new J(null, x[0], x[1], a), d.normalizeWhenReady = x[0], d.convolveWhenReady = S),
			ft(g, S);
			break;
		case "flanger":
	...
	ot.afterLoad = function () {
		var t, e, i, r;
		for (t = 0, e = ht.length; t < e; t++) i = ht[t],
	...
	ot.tick = function () {
		...
		for (t = 0, e = p.length; t < e; t++)(i = p[t]).tick(o),
		0 !== g && i.updatePlaybackRate();
		for (r in j) if (j.hasOwnProperty(r)) for (t = 0, e = (n = j[r]).length; t < e; t++)(s = n[t]).tick && s.tick();
	...
	ot.setPreloadList = function (t) {
		var e, i, r, n, s, a, o = 0;
		for (e = 0, i = t.length; e < i; ++e) n = (r = t[e])[0],
		s = 2 * r[1],
	...
	ot.startPreloads = function () {
		var t, e, i, r;
		for (t = 0, e = ct.length; t < e; ++t) i = ct[t],
	...
	ot.releaseAllMusicBuffers = function () {
		var t, e, i, r;
		for (t = 0, i = 0, e = u.length; t < e; ++t) r = u[t],
		u[i] = r,
	...
	ot.getAudioBuffer = function (t, e, i) {
		var r, n, s, a = null;
		for (r = 0, n = u.length; r < n; r++) if ((s = u[r]).src === t) {
			a = s;
			break
		}
		return a || i || (P && e && this.releaseAllMusicBuffers(), a = new st(t, e), u.push(a)),
		a
	},
	ot.getAudioInstance = function (t, e, i, r, n) {
		var s, a, o;
		for (s = 0, a = p.length; s < a; s++) if ((o = p[s]).src === t && (o.canBeRecycled() || i)) return o.tag = e,
		o;
	...
	function pt(t, e) {
		...
		var i, r, n;
		for (i = 0, r = p.length; i < r; i++) n = p[i],
		cr.equals_nocase(t, n.tag) && lt.push(n);
		e && lt.sort(ut)
	}
	function dt(t) {
		var e, i, r, n, s = l.destination;
		if (j.hasOwnProperty(t) && (r = j[t]).length) for (s = r[0].getInputNode(), e = 0, i = r.length; e < i; e++) n = r[e],
	...
	gt.prototype.PreloadsComplete = function () {
		var t, e;
		for (t = 0, e = u.length; t < e; t++) if (!u[t].isLoadedAndDecoded() && !u[t].hasFailedToLoad()) return ! 1;
		return ! 0
	},
	...
	gt.prototype.IsAnyPlaying = function () {
		var t, e;
		for (t = 0, e = p.length; t < e; t++) if (p[t].isPlaying()) return ! 0;
		return ! 1
	},
	gt.prototype.IsTagPlaying = function (t) {
		var e, i;
		for (pt(t), e = 0, i = lt.length; e < i; e++) if (lt[e].isPlaying()) return ! 0;
		return ! 1
	},
	t.cnds = new gt,
	...
	yt.prototype.PlayAtPosition = function (t, e, i, r, n, s, a, o, h, c) {
		if (!y) {
			...
			if (d = this.getAudioInstance(p, c, u, 0 !== e, l)) d.setPannerEnabled(!0),
	...
	yt.prototype.PlayAtPositionByName = function (t, e, i, r, n, s, a, o, h, c, l) {
		if (!y) {
			...
			if (d = this.getAudioInstance(g, l, p, 0 !== i, u)) d.setPannerEnabled(!0),
	...
	yt.prototype.AddConvolutionEffect = function (t, e, i, r) {
		if (c === a && l.createConvolver) {
			...
			(r /= 100) < 0 && (r = 0),
			r > 1 && (r = 1),
			h.bufferObject ? n = new J(h.bufferObject, s, r, o) : (n = new J(null, s, r, o), h.normalizeWhenReady = s, h.convolveWhenReady = n),
			ft(t, n)
		}
	},
...
function () {
	...
	Acts.prototype.RequestFullScreen = function (t) {
		if (this.runtime.isDomFree) cr.logexport("[Construct 2] Requesting fullscreen is not supported on this platform - the request has been ignored");
			...
			firstRequestFullscreen && (firstRequestFullscreen = !1, crruntime = this.runtime, e.addEventListener("mozfullscreenerror", onFullscreenError), e.addEventListener("webkitfullscreenerror", onFullscreenError), e.addEventListener("MSFullscreenError", onFullscreenError), e.addEventListener("fullscreenerror", onFullscreenError)),
...
function () {
	...
	r.prototype.JSONLoad = function (t) {
		...
		if (e.c2dictionary) for (var i in this.dictionary = e.data, this.key_count = 0, this.dictionary) this.dictionary.hasOwnProperty(i) && this.key_count++
	},
...
function () {
	...
	t.Instance.prototype.onCreate = function () {
		...
		window.c2_callFunction = function (e, i) {
			var n, a, o, h = r();
			if (h.name = e.toLowerCase(), h.retVal = 0, i) for (h.params.length = i.length, n = 0, a = i.length; n < a; ++n) o = i[n],
...
function () {
	...
	e.onKeyDown = function (t) {
		...
		if (window != window.top && i.indexOf(t.which) > -1 && (t.preventDefault(), e = !0, t.stopPropagation()), this.keyMap[t.which]) this.usedKeys[t.which] && !e && t.preventDefault();
			...
			(r || n) && (this.usedKeys[t.which] = !0, e || t.preventDefault())
		}
	},
	e.onKeyUp = function (t) {
		...
		this.runtime.isInUserInputEvent = !1,
		(e || i || this.usedKeys[t.which]) && (this.usedKeys[t.which] = !0, t.preventDefault())
	},
	e.onWindowBlur = function () {
		var t;
		for (t = 0; t < 256; ++t) if (this.keyMap[t]) {
			this.keyMap[t] = !1,
			this.triggerKey = t,
			this.runtime.trigger(cr.plugins_.Keyboard.prototype.cnds.OnAnyKeyReleased, this);
			var e = this.runtime.trigger(cr.plugins_.Keyboard.prototype.cnds.OnKeyReleased, this),
...
try { !
	function () {
		...
		i = e = function (t) {
			...
			if (n[t] = {},
			!r[t]) throw new Error("Could not find module " + t);
		...
		t("promise/asap", ["exports"], function (t) {
			...
			a = [];
			i = "undefined" != typeof process && "[object process]" === {}.toString.call(process) ?
			function () {
				process.nextTick(e)
			}: n ?
			function () {
		...
		t("promise/polyfill", ["./promise", "./utils", "exports"], function (t, e, i) {
			...
			i.polyfill = function () {
				var t;
				"Promise" in (t = "undefined" != typeof global ? global: "undefined" != typeof window && window.document ? window: self) && "resolve" in t.Promise && "reject" in t.Promise && "all" in t.Promise && "race" in t.Promise &&
				function () {
					var e;
			...
			var r = function (t) {
				...
				function r() {
					for (var t = 1; t < arguments.length; t++) {
						var e = arguments[t];
						if (e) for (var i in e) e.hasOwnProperty(i) && (l(e[i]) ? arguments[0][i] = e[i].slice() : arguments[0][i] = e[i])
					}
					return arguments[0]
				}
				function n(t) {
				...
				return new(function () {
					...
					return t.prototype.config = function (t) {
						if ("object" == typeof t) {
							...
							for (var e in t)"storeName" === e && (t[e] = t[e].replace(/\W/g, "_")),
							this._config[e] = t[e];
					...
					t.prototype.setDriver = function (t, e, i) {
						...
						a = null !== this._driverSet ? this._driverSet.
						catch(function () {
				...
				if (l) {
					...
					return {
						...
						_initStorage: function (t) {
							...
							p[r.name] = s),
							s.forages.push(i),
							i._initReady || (i._initReady = i.ready, i.ready = a);
							for (var c = [], l = 0; l < s.forages.length; l++) {
								var u = s.forages[l];
								u !== i && c.push(u._initReady().
								catch(e))
							}
							...
							return new Promise(function (e, s) {
								...
								o.serializer.serialize(n, function (n, a) {
									if (a) s(a);
										...
										e(t)
									} catch(t) { ("QuotaExceededError" === t.name || "NS_ERROR_DOM_QUOTA_REACHED" === t.name) && s(t),
										s(t)
									}
								})
							})
		...
		function (t, e) {
			...
			var i = function (t) {
				...
				function i(t) {
					...
					u = new Uint8Array(l);
					for (e = 0; h > e; e += 4) i = n.indexOf(t[e]),
					r = n.indexOf(t[e + 1]),
					s = n.indexOf(t[e + 2]),
					a = n.indexOf(t[e + 3]),
					u[c++] = i << 2 | r >> 4,
				...
				function r(t) {
					...
					r = "";
					for (e = 0; e < i.length; e += 3) r += n[i[e] >> 2],
					r += n[(3 & i[e]) << 4 | i[e + 1] >> 4],
			...
			var r = function (t) {
				...
				if (r) return {
					...
					_initStorage: function (t) {
						...
						if (t) for (var s in t) n[s] = "string" != typeof t[s] ? t[s].toString() : t[s];
						var a = new Promise(function (t, i) {
							try {
...
function () {
	...
	p.prototype.SetItem = function (i, o) {
		if (localForageInitFailed) s(this, "storage failed to initialise - may be disabled in browser settings");
			...
			this.pendingSets++;
			var c = this;
			localforage.setItem(h, o, function (s, a) { ! 0,
				c.pendingSets--,
				s ? (r = n(s), c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, c)) : (t = i, e = a, c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAnyItemSet, c), c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemSet, c), t = "", e = ""),
	...
	p.prototype.GetItem = function (i) {
		if (localForageInitFailed) s(this, "storage failed to initialise - may be disabled in browser settings");
			...
			localforage.getItem(o, function (s, a) {
				h.pendingGets--,
				s ? (r = n(s), h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, h)) : (t = i, void 0 !== (e = a) && null !== e || (e = ""), h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAnyItemGet, h), h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemGet, h), t = "", e = ""),
	...
	p.prototype.RemoveItem = function (i) {
		if (localForageInitFailed) s(this, "storage failed to initialise - may be disabled in browser settings");
			...
			var o = a + i,
			h = this;
			localforage.removeItem(o, function (s) { ! 0,
				s ? (r = n(s), h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, h)) : (t = i, e = "", h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAnyItemRemoved, h), h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemRemoved, h), t = "")
			})
		}
	},
	p.prototype.ClearStorage = function () {
		if (localForageInitFailed) s(this, "storage failed to initialise - may be disabled in browser settings");
			...
			var a = this;
			localforage.clear(function (s) { ! 0,
				s ? (r = n(s), a.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, a)) : (t = "", e = "", cr.clearArray(i), a.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnCleared, a))
			})
		}
	},
	...
	d.prototype.KeyAt = function (t, e) { (e = Math.floor(e)) < 0 || e >= i.length ? t.set_string("") : t.set_string(i[e])
	},
...
function () {
	...
	e.onRestoreWebGLContext = function () { ! this.is_family && this.instances.length && (this.webGL_texture || (this.webGL_texture = this.runtime.glwrap.loadTexture(this.texture_img, !0, this.runtime.linearSampling, this.texture_pixelformat)))
	},
...
function () {
	...
	i.prototype.draw = function (t) {
		...
		if (0 !== e) {
			...
			this.owner.runtime.pixel_rounding && (i = i + .5 | 0, r = r + .5 | 0),
	...
	i.prototype.drawGL = function (t) {
		...
		n = this.x - i / 2,
		s = this.y - i / 2;
		this.owner.runtime.pixel_rounding && (n = n + .5 | 0, s = s + .5 | 0),
		r < 1 || 0 === e || (r < t.minPointSize || r > t.maxPointSize ? (t.setOpacity(e), t.quad(n, s, n + i, s, n + i, s + i, n, s + i)) : t.point(this.x, this.y, r, e))
	},
	...
	r.onCreate = function () {
		...
		}), this.recycled || (this.particles = []), this.runtime.tickMe(this), this.type.loadTextures(), 1 === this.spraytype) for (var e = 0; e < this.rate; e++) this.allocateParticle().opacity = 0;
		this.first_tick = !0
	},
	r.saveToJSON = function () {
		...
		n = r.p;
		for (t = 0, e = this.particles.length; t < e; t++) i = this.particles[t],
	...
	r.loadFromJSON = function (t) {
		...
		var a = t.p;
		for (e = 0, i = a.length; e < i; e++) r = this.allocateParticle(),
		s = a[e],
		r.x = s[0],
		r.y = s[1],
		r.speed = s[2],
	...
	r.tick = function () {
		...
		if (0 === this.spraytype && this.spraying) for (this.particleCreateCounter += a * this.rate, r = cr.floor(this.particleCreateCounter), this.particleCreateCounter -= r, t = 0; t < r; t++)(i = this.allocateParticle()).init();
		for (this.particleBoxLeft = this.x, this.particleBoxTop = this.y, this.particleBoxRight = this.x, this.particleBoxBottom = this.y, t = 0, s = 0, e = this.particles.length; t < e; t++) i = this.particles[t],
		this.particles[s] = i,
		this.runtime.redraw = !0,
		1 === this.spraytype && this.first_tick && i.init(),
		i.tick(a),
		i.active ? (i.left() < this.particleBoxLeft && (this.particleBoxLeft = i.left()), i.right() > this.particleBoxRight && (this.particleBoxRight = i.right()), i.top() < this.particleBoxTop && (this.particleBoxTop = i.top()), i.bottom() > this.particleBoxBottom && (this.particleBoxBottom = i.bottom()), s++) : n.push(i);
	...
	a.prototype.SetRate = function (t) {
		var e, i;
		if (this.rate = t, 1 === this.spraytype && this.first_tick) if (t < this.particles.length) for (e = this.particles.length - t, i = 0; i < e; i++) n.push(this.particles.pop());
		else if (t > this.particles.length) for (e = t - this.particles.length, i = 0; i < e; i++) this.allocateParticle().opacity = 0
	},
...
function () {
	...
	e.onCreate = function () {
		...
		if (!this.is_family) for (this.all_frames = [], this.has_loaded_textures = !1, t = 0, e = this.animations.length; t < e; t++) {
			for (s = this.animations[t], (o = {}).name = s[0], o.speed = s[1], o.loop = s[2], o.repeatcount = s[3], o.repeatto = s[4], o.pingpong = s[5], o.sid = s[6], o.frames = [], r = 0, n = s[7].length; r < n; r++) a = s[7][r],
			(h = {}).texture_file = a[0],
			...
			(c = this.runtime.findWaitingTexture(a[0])) ? h.texture_img = c: (h.texture_img = new Image, h.texture_img.cr_src = a[0], h.texture_img.cr_filesize = a[1], h.texture_img.c2webGL_texture = null, this.runtime.waitForImageLoad(h.texture_img, a[0])),
			cr.seal(h),
			o.frames.push(h),
	...
	e.onLostWebGLContext = function () {
		if (!this.is_family) {
			var t, e, i;
			for (t = 0, e = this.all_frames.length; t < e; ++t)(i = this.all_frames[t]).texture_img.c2webGL_texture = null,
	...
	e.preloadCanvas2D = function (t) {
		var e, i, n;
		for (cr.clearArray(r), e = 0, i = this.all_frames.length; e < i; ++e) n = this.all_frames[e].texture_img,
		-1 === r.indexOf(n) && (t.drawImage(n, 0, 0), r.push(n))
	},
	t.Instance = function (t) {
		this.type = t,
		this.runtime = t.runtime;
	...
	n.getAnimationByName = function (t) {
		var e, i, r;
		for (e = 0, i = this.type.animations.length; e < i; e++) if (r = this.type.animations[e], cr.equals_nocase(r.name, t)) return r;
		return null
	},
	n.getAnimationBySid = function (t) {
		var e, i, r;
		for (e = 0, i = this.type.animations.length; e < i; e++) if ((r = this.type.animations[e]).sid === t) return r;
		return null
	},
	...
	n.doChangeAnimFrame = function () {
		...
		this.cur_frame < 0 && (this.cur_frame = 0),
		this.cur_frame >= this.cur_animation.frames.length && (this.cur_frame = this.cur_animation.frames.length - 1),
		e !== this.cur_frame && (this.OnFrameChanged(t, this.cur_animation.frames[this.cur_frame]), this.frameStart = this.getNowTime(), this.runtime.redraw = !0),
	...
	n.draw = function (t) {
		...
		a = this.width,
		o = this.height;
		if (0 === this.angle && a >= 0 && o >= 0) n -= this.hotspotX * a,
		s -= this.hotspotY * o,
		this.runtime.pixel_rounding && (n = Math.round(n), s = Math.round(s)),
	...
	n.getImagePointIndexByName = function (t) {
		...
		for (e = 0, i = r.image_points.length; e < i; e++) if (cr.equals_nocase(t, r.image_points[e][0])) return e;
		return - 1
	},
	...
	s.prototype.OnCollision = function (t) {
		...
		i.extra.spriteCreatedDestroyCallback || (i.extra.spriteCreatedDestroyCallback = !0, e.addDestroyCallback(function (t) { !
			function (t, e) {
				var i, r, n = e.uid;
		...
		if (y) {
			if (t) {
				...
				if (s.select_all) {
					...
					if (n) for (cr.clearArray(s.else_instances), e = 0, i = f.instances.length; e < i; ++e) r = f.instances[e],
					g.contains(r) || s.else_instances.push(r)
				} else if (n) {
					var o = s.instances.length;
					for (e = 0, i = a.length; e < i; ++e) s.instances[o + e] = a[e],
	...
	b.prototype.Spawn = function (t, e, i) {
		if (t && e) {
			...
			if (r) {
				var n, s, a;
				if (void 0 !== r.angle && (r.angle = this.angle, r.set_bbox_changed()), this.runtime.isInOnDestroy++, this.runtime.trigger(Object.getPrototypeOf(t.plugin).cnds.OnCreated, r), r.is_contained) for (n = 0, s = r.siblings.length; n < s; n++) a = r.siblings[n],
				this.runtime.trigger(Object.getPrototypeOf(a.type.plugin).cnds.OnCreated, a);
				this.runtime.isInOnDestroy--;
				var o, h = this.runtime.getCurrentAction(),
				c = !1;
				if ((cr.is_undefined(h.extra.Spawn_LastExec) || h.extra.Spawn_LastExec < this.runtime.execcount) && (c = !0, h.extra.Spawn_LastExec = this.runtime.execcount), t != this.type && ((o = t.getCurrentSol()).select_all = !1, c ? (cr.clearArray(o.instances), o.instances[0] = r) : o.instances.push(r), r.is_contained)) for (n = 0, s = r.siblings.length; n < s; n++)(o = (a = r.siblings[n]).type.getCurrentSol()).select_all = !1,
				c ? (cr.clearArray(o.instances), o.instances[0] = a) : o.instances.push(a)
			}
		}
	},
	...
	b.prototype.StartAnim = function (t) {
		...
		1 === t && 0 !== this.cur_frame && (this.changeAnimFrame = 0, this.inAnimTrigger || this.doChangeAnimFrame()),
	...
	b.prototype.SetAnimRepeatToFrame = function (t) { (t = Math.floor(t)) < 0 && (t = 0),
	...
	b.prototype.LoadURL = function (t, e, i) {
		...
		s = this.curFrame;
		r.onload = function () {
			if (s.texture_img.src === r.src) return n.runtime.glwrap && n.curFrame === s && (n.curWebGLTexture = s.webGL_texture),
			0 === e && (n.width = r.width, n.height = r.height, n.set_bbox_changed()),
			n.runtime.redraw = !0,
			...
			s.datauri = "",
			s.pixelformat = 0,
			n.runtime.glwrap && (s.webGL_texture && n.runtime.glwrap.deleteTexture(s.webGL_texture), s.webGL_texture = n.runtime.glwrap.loadTexture(r, !1, n.runtime.linearSampling), n.curFrame === s && (n.curWebGLTexture = s.webGL_texture), n.type.updateAllCurrentTexture()),
			0 === e && (n.width = r.width, n.height = r.height, n.set_bbox_changed()),
			n.runtime.redraw = !0,
...
function () {
	...
	e.onRestoreWebGLContext = function () {
		var t, e;
		if (!this.is_family && this.instances.length) for (this.webGL_texture || (this.webGL_texture = this.runtime.glwrap.loadTexture(this.texture_img, !1, this.runtime.linearSampling, this.texture_pixelformat)), t = 0, e = this.instances.length; t < e; t++) this.instances[t].webGL_texture = this.webGL_texture
	},
	e.unloadTextures = function () {
		this.is_family || this.instances.length || !this.webGL_texture || (this.runtime.glwrap.deleteTexture(this.webGL_texture), this.webGL_texture = null)
	},
	...
	i.onCreate = function () {
		...
		this.recycled ? (this.lines.length = 0, cr.wipe(this.clipList), cr.wipe(this.clipUV), cr.wipe(this.characterWidthList)) : (this.lines = [], this.clipList = {},
		this.clipUV = {},
		this.characterWidthList = {});
		try {
			if (this.charWidthJSON) if ( - 1 !== this.charWidthJSON.indexOf('""c2array""')) for (var t = (s = jQuery.parseJSON(this.charWidthJSON.replace(/""/g, '"'))).size[1], e = 0; e < t; e++) for (var i = s.data[1][e][0], r = s.data[0][e][0], n = 0; n < i.length; n++) this.characterWidthList[i.charAt(n)] = r;
			else {
				var s;
				for (t = (s = jQuery.parseJSON(this.charWidthJSON)).length, e = 0; e < t; e++) for (i = s[e][1], r = s[e][0], n = 0; n < i.length; n++) this.characterWidthList[i.charAt(n)] = r
		...
		this.runtime.glwrap && (this.type.webGL_texture || (this.type.webGL_texture = this.runtime.glwrap.loadTexture(this.type.texture_img, !1, this.runtime.linearSampling, this.type.texture_pixelformat)), this.webGL_texture = this.type.webGL_texture),
		this.SplitSheet()
	},
	i.saveToJSON = function () {
		var t = {
	...
	t.TokeniseWords = function (t) {
		g.length = 0;
		for (var e, i = "", r = 0; r < t.length;) if ("\n" === (e = t.charAt(r))) i.length && (g.push(i), i = ""),
		g.push("\n"),
		++r;
		else if (" " === e || "\t" === e || "-" === e) {
			do {
	...
	t.WrapText = function (t) {
		...
		for (r(d).length && (h(t, f, d), f++), u = f; u < s.length; u++) p = s[u],
		a(c, p);
		s.length = f
	},
	...
	i.rebuildText = function () { (this.text_changed || this.width !== this.lastwrapwidth) && (this.textWidth = 0, this.textHeight = 0, this.type.plugin.WordWrap(this), this.text_changed = !1, this.lastwrapwidth = this.width)
	};
	i.draw = function (t, e) {
		...
		if ("" !== this.text && null != i) {
			...
			var r = this.x,
			n = this.y;
			this.runtime.pixel_rounding && (r = r + .5 | 0, n = n + .5 | 0),
			t.save(),
			t.translate(r, n),
			t.rotate(this.angle);
	...
	v.prototype.SetCharacterWidth = function (t, e) {
		if ("" !== t) for (var i = 0; i < t.length; i++) this.SetCharWidth(t.charAt(i), e)
	},
...
function () {
	...
	i.onCreate = function () {
		...
		this.textWidth = 0,
		this.textHeight = 0,
		this.recycled ? (cr.clearArray(this.lines), cr.wipe(this.clipList), cr.wipe(this.clipUV), cr.wipe(this.characterWidthList)) : (this.lines = [], this.clipList = {},
		this.clipUV = {},
		this.characterWidthList = {}),
		this.text_changed = !0,
		this.lastwrapwidth = this.width,
				...
				if (l = S + f * cr.max(0, this.width - k), O += _, 0 === d && n + O + m < a) O += m;
					...
					for (var E = 0; E < A.length; E++) {
						...
						if (0 === d && r + l + c * y + v < s) l += c * y + v;
							...
							if (void 0 !== I && (u = l, p = O, 0 === d && 1 === y && (u = Math.round(u), p = Math.round(p)), t.drawImage(this.texture_img, I.x, I.y, I.w, I.h, u, p, I.w * y, I.h * y)), l += c * y + v, 0 === d && r + l > o) break
						}
					}
	...
	i.drawGL = function (t) {
		if (t.setTexture(this.webGL_texture), t.setOpacity(this.opacity), this.text && (this.rebuildText(), !(this.height < this.characterHeight * this.characterScale + this.lineHeight))) {
			...
			for (var x, S, T, O = d * cr.max(0, this.height - w), C = e.tlx + i, A = e.tly + r, k = O, E = 0; E < b.length; E++) {
				var P = b[E].text,
				I = b[E].width;
				if (x = p * cr.max(0, this.width - I), k += _, 0 === u && A + k + g < h) k += g;
				else {
					for (var L = 0; L < P.length; L++) {
						...
						if (0 === u && C + x + n * f + v < o) x += n * f + v;
							...
							if (void 0 !== N) {
								...
								S = x,
								T = k,
								0 === u && 1 === f && (S = Math.round(S), T = Math.round(T)),
								y.tlx = S,
								y.tly = T,
								y.trx = S + B,
								y.try_ = T,
...
function () {
	...
	e.onRestoreWebGLContext = function () {
		var t, e;
		if (!this.is_family && this.instances.length) for (this.webGL_texture || (this.webGL_texture = this.runtime.glwrap.loadTexture(this.texture_img, !0, this.runtime.linearSampling, this.texture_pixelformat)), t = 0, e = this.instances.length; t < e; t++) this.instances[t].webGL_texture = this.webGL_texture
	},
	e.loadTextures = function () {
		this.is_family || this.webGL_texture || !this.runtime.glwrap || (this.webGL_texture = this.runtime.glwrap.loadTexture(this.texture_img, !0, this.runtime.linearSampling, this.texture_pixelformat))
	},
	...
	i.onCreate = function () {
		...
		this.texture_img = this.type.texture_img,
		this.runtime.glwrap ? (this.type.loadTextures(), this.webGL_texture = this.type.webGL_texture) : (this.type.pattern || (this.type.pattern = this.runtime.ctx.createPattern(this.type.texture_img, "repeat")), this.pattern = this.type.pattern)
	},
	...
	n.prototype.LoadURL = function (t, e) {
		...
		i.onload = function () {
			r.texture_img = i,
			r.runtime.glwrap ? (r.has_own_texture && r.webGL_texture && r.runtime.glwrap.deleteTexture(r.webGL_texture), r.webGL_texture = r.runtime.glwrap.loadTexture(i, !0, r.runtime.linearSampling)) : r.pattern = r.runtime.ctx.createPattern(i, "repeat"),
			r.has_own_texture = !0,
			r.runtime.redraw = !0,
...
function () {
	...
	e.onCreate = function () {
		...
		window.addEventListener("devicemotion", function (t) {
			t.accelerationIncludingGravity && (i.acc_g_x = t.accelerationIncludingGravity.x || 0, i.acc_g_y = t.accelerationIncludingGravity.y || 0, i.acc_g_z = t.accelerationIncludingGravity.z || 0),
			t.acceleration && (i.acc_x = t.acceleration.x || 0, i.acc_y = t.acceleration.y || 0, i.acc_z = t.acceleration.z || 0)
		},
		!1);
	...
	e.onPointerEnd = function (t, e) {
		if (t.pointerType !== t.MSPOINTER_TYPE_MOUSE && "mouse" !== t.pointerType) {
			...
			i >= 0 && (e || this.touches[i].maybeTriggerTap(this, i), c(this.touches[i]), this.touches.splice(i, 1)),
			this.runtime.isInUserInputEvent = !1
		}
	},
	...
	e.onTouchStart = function (t) {
		...
		cr.performance_now();
		for (this.runtime.isInUserInputEvent = !0, e = 0, r = t.changedTouches.length; e < r; e++) if (n = t.changedTouches[e], -1 === this.findTouch(n.identifier)) {
	...
	e.onTouchEnd = function (t, e) {
		var i, r, n, s;
		for (t.preventDefault && cr.isCanvasInputEvent(t) && t.preventDefault(), this.runtime.isInUserInputEvent = !0, i = 0, r = t.changedTouches.length; i < r; i++) n = t.changedTouches[i],
		(s = this.findTouch(n.identifier)) >= 0 && (this.trigger_index = this.touches[s].startindex, this.trigger_id = this.touches[s].id, this.runtime.trigger(cr.plugins_.Touch.prototype.cnds.OnNthTouchEnd, this), this.runtime.trigger(cr.plugins_.Touch.prototype.cnds.OnTouchEnd, this), e || this.touches[s].maybeTriggerTap(this, s), c(this.touches[s]), this.touches.splice(s, 1));
		this.runtime.isInUserInputEvent = !1
	},
	e.getAlpha = function () {
	...
	e.tick2 = function () {
		...
		for (t = 0, e = this.touches.length; t < e; ++t)(i = this.touches[t]).time <= r - 50 && (i.lasttime = r),
	...
	m.prototype.AbsoluteXAt = function (t, e) { (e = Math.floor(e)) < 0 || e >= this.touches.length ? t.set_float(0) : t.set_float(this.touches[e].x)
	},
	...
	m.prototype.AbsoluteYAt = function (t, e) { (e = Math.floor(e)) < 0 || e >= this.touches.length ? t.set_float(0) : t.set_float(this.touches[e].y)
	},
...
function () {
	...
	e.tick = function () {
		if (this.enabled) {
			...
			i = this.inst,
			r = this.inst.bbox;
			0 === this.anch_left ? (i.update_bbox(), 0 !== (t = e.viewLeft + this.xleft - r.left) && (i.x += t, i.set_bbox_changed())) : 1 === this.anch_left && (i.update_bbox(), 0 !== (t = e.viewRight - this.xright - r.left) && (i.x += t, i.set_bbox_changed())),
			0 === this.anch_top ? (i.update_bbox(), 0 !== (t = e.viewTop + this.ytop - r.top) && (i.y += t, i.set_bbox_changed())) : 1 === this.anch_top && (i.update_bbox(), 0 !== (t = e.viewBottom - this.ybottom - r.top) && (i.y += t, i.set_bbox_changed())),
			1 === this.anch_right && (i.update_bbox(), 0 !== (t = e.viewRight - this.rdiff - r.right) && (i.width += t, i.width < 0 && (i.width = 0), i.set_bbox_changed())),
			1 === this.anch_bottom && (i.update_bbox(), 0 !== (t = e.viewBottom - this.bdiff - r.bottom) && (i.height += t, i.height < 0 && (i.height = 0), i.set_bbox_changed()))
		}
	},
	t.cnds = new
	function () {},
...
function () {
	...
	e.onCreate = function () {
		...
		this.activeAtStart && (0 === this.fadeInTime ? (this.stage = 1, 0 === this.waitTime && (this.stage = 2)) : (this.inst.opacity = 0, this.runtime.redraw = !0))
	},
	e.saveToJSON = function () {
		return {
			fit: this.fadeInTime,
	...
	e.tick = function () {
		...
		0 === this.stage && (this.inst.opacity = this.stageTime.sum / this.fadeInTime * this.maxOpacity, this.runtime.redraw = !0, this.inst.opacity >= this.maxOpacity && (this.inst.opacity = this.maxOpacity, this.stage = 1, this.stageTime.reset(), this.runtime.trigger(cr.behaviors.Fade.prototype.cnds.OnFadeInEnd, this.inst))),
		1 === this.stage && this.stageTime.sum >= this.waitTime && (this.stage = 2, this.stageTime.reset(), this.runtime.trigger(cr.behaviors.Fade.prototype.cnds.OnWaitEnd, this.inst)),
		2 === this.stage && 0 !== this.fadeOutTime && (this.inst.opacity = this.maxOpacity - this.stageTime.sum / this.fadeOutTime * this.maxOpacity, this.runtime.redraw = !0, this.inst.opacity < 0 && (this.inst.opacity = 0, this.stage = 3, this.stageTime.reset(), this.runtime.trigger(cr.behaviors.Fade.prototype.cnds.OnFadeOutEnd, this.inst), 1 === this.destroy && this.runtime.DestroyInstance(this.inst)))
	},
	e.doStart = function () {
		this.stage = 0,
		this.stageTime.reset(),
		0 === this.fadeInTime ? (this.stage = 1, 0 === this.waitTime && (this.stage = 2)) : (this.inst.opacity = 0, this.runtime.redraw = !0)
	},
	...
	r.prototype.StartFade = function () {
		this.activeAtStart || this.setMaxOpacity || (this.maxOpacity = this.inst.opacity ? this.inst.opacity: 1, this.setMaxOpacity = !0),
...
function () {
	...
	e.afterLoad = function () { - 1 === this.pinObjectUid ? this.pinObject = null: this.pinObject = this.runtime.getObjectByUID(this.pinObjectUid),
		this.pinObjectUid = -1
	},
	...
	e.tick2 = function () {
		if (this.pinObject) {
			...
			} else t = this.pinObject.x + Math.cos(this.pinObject.angle + this.pinAngle) * this.pinDist,
			...
			0 !== this.mode && 1 !== this.mode && 3 !== this.mode && 4 !== this.mode || this.inst.x === t && this.inst.y === e || (this.inst.x = t, this.inst.y = e, this.inst.set_bbox_changed()),
			0 !== this.mode && 2 !== this.mode || this.inst.angle === n || (this.inst.angle = n, this.inst.set_bbox_changed())
		}
	},
...
function () {
	...
	e.onCreate = function () {
		...
		0 === this.period ? this.i = 0 : (this.i = this.properties[5] / this.period * i, this.i += Math.random() * this.properties[6] / this.period * i),
...
function () {
	...
	e.loadFromJSON = function (t) {
		...
		t) t.hasOwnProperty(e) && (this.timers[e] = {
...
function easeFunc(t, e, i, r, n, s, a) {
	...
	case 19:
		if (a.optimized) o = easeInElasticArray[integerize(e, n)];
			...
			l = a.p;
			h = 0;
			if (0 == e && (o = i), 1 == (e /= n) && (o = i + r), 0 == l && (l = .3 * n), 0 == c || c < Math.abs(r)) c = r,
			h = l / 4;
...
var TweenObject = function (t, e, i, r, n, s, a) {
	...
	this.easingparam = [],
	this.lastState = 1;
	for (var o = 0; o < 28; o++) this.easingparam[o] = {},
...
TweenObject.prototype.OnTick = function (t) {
	...
	if (1 === this.state && (this.progress += t), 2 === this.state && (this.progress -= t), 3 === this.state && (this.state = 0), 4 !== this.state && 6 !== this.state || (this.progress += t * this.pingpong), 5 === this.state && (this.progress += t * this.pingpong), this.progress < 0) return this.progress = 0,
	4 === this.state ? this.pingpong = 1 : 6 === this.state ? (this.pingpong = 1, this.flipEase = !1) : this.state = 0,
	this.onReverseEnd = !0,
	0;
	if (this.progress > this.duration) return this.progress = this.duration,
	4 === this.state ? this.pingpong = -1 : 6 === this.state ? (this.pingpong = -1, this.flipEase = !0) : 5 === this.state ? this.progress = 0 : this.state = 0,
	this.onEnd = !0,
	1;
...
function () {
	...
	e.saveToJSON = function () {
		JSON.stringify(this.tween_list.
	default);
		return {
			playmode:
			this.playmode,
			...
			value: this.value,
			tweenlist: JSON.stringify(this.tween_list.
		default)
		}
	},
	...
	e.startTween = function (t) {
		for (var e in this.tween_list) {
			...
			0 === t && (i.progress = 1e-6, i.lastKnownValue = 0, i.lastKnownValue2 = 0, i.onStart = !0, i.state = 1),
			1 === t && (i.state = i.lastState),
			2 !== t && 4 !== t || (i.progress = 1e-6, i.lastKnownValue = 0, i.lastKnownValue2 = 0, i.onStart = !0, 2 == t && (i.state = 4), 4 == t && (i.state = 6)),
			3 === t && (i.progress = 1e-6, i.lastKnownValue = 0, i.lastKnownValue2 = 0, i.onStart = !0, i.state = 5)
		}
	},
	...
	e.reverseTween = function (t) {
		for (var e in this.tween_list) {
			var i = this.tween_list[e];
			1 === t && (i.progress = i.duration, i.lastKnownValue = 0, i.lastKnownValue2 = 0, i.onReverseStart = !0),
			i.state = 2
		}
	},
	e.updateTween = function (t, e) {
		...
		else if (4 === t.tweened) if (t.enforce) {
	...
	default;
		if (0 !== e.state) {
			e.onStart && (this.runtime.trigger(cr.behaviors.lunarray_LiteTween.prototype.cnds.OnStart, this.inst), e.onStart = !1),
			e.onReverseStart && (this.runtime.trigger(cr.behaviors.lunarray_LiteTween.prototype.cnds.OnReverseStart, this.inst), e.onReverseStart = !1),
			this.active = 1 == e.state || 2 == e.state || 4 == e.state || 5 == e.state || 6 == e.state;
			var i = e.OnTick(t);
			this.updateTween(e, i),
			e.onEnd && (this.runtime.trigger(cr.behaviors.lunarray_LiteTween.prototype.cnds.OnEnd, this.inst), e.onEnd = !1),
			e.onReverseEnd && (this.runtime.trigger(cr.behaviors.lunarray_LiteTween.prototype.cnds.OnReverseEnd, this.inst), e.onReverseEnd = !1)
		}
	},
	t.cnds = {};
	var i = t.cnds;
	i.IsActive = function () {
		return 0 !== this.tween_list.
	default.state
	},
	i.IsReversing = function () {
		return 2 == this.tween_list.
	default.state
	},
	i.CompareProgress = function (t, e) {
		var i = this.tween_list.
	default;
	...
	i.OnStart = function () {
		return void 0 !== this.tween_list.
	default && this.tween_list.
	default.onStart
	},
	i.OnReverseStart = function () {
		return void 0 !== this.tween_list.
	default && this.tween_list.
	default.onReverseStart
	},
	i.OnEnd = function () {
		return void 0 !== this.tween_list.
	default && this.tween_list.
	...
	r.SetDuration = function (t) {
		isNaN(t) || t < 0 || void 0 !== this.tween_list.
	default && (this.tween_list.
	default.duration = t)
	},
	r.SetEnforce = function (t) {
		void 0 !== this.tween_list.
	default && (this.tween_list.
	default.enforce = 1 === t)
	},
	r.SetInitial = function (t) {
		if (void 0 !== this.tween_list.
	default) {
			var e = this.parseCurrent(this.tween_list.
		default.tweened, t);
			this.tween_list.
		default.setInitial(e)
		}
	},
	r.SetTarget = function (t, e, i) {
		if (void 0 !== this.tween_list.
	default && !isNaN(i)) {
			var r = this.tween_list.
		default,
			n = i + "";
			this.targetmode = e;
			var s = "",
			...
			var o = this.parseCurrent(this.tween_list.
		default.tweened, "current"),
			h = this.parseCurrent(this.tween_list.
		default.tweened, n);
			r.setInitial(o),
			r.setTarget(h)
		}
	...
	r.SetEasingParam = function (t, e, i, r, n) {
		void 0 !== this.tween_list.
	default && (this.tween_list.
	default.easingparam[t].optimized = !1, this.tween_list.
	default.easingparam[t].a = e, this.tween_list.
	default.easingparam[t].p = i, this.tween_list.
	default.easingparam[t].t = r, this.tween_list.
	default.easingparam[t].s = n)
	},
	...
	r.SetParameter = function (t, e, i, r, n) {
		if (void 0 === this.tween_list.
	default) this.addToTweenList("default", t, e, initial, i, r, n, 0);
		else {
			var s = this.tween_list.
		default;
			s.tweened = t,
			s.easefunc = e,
	...
	n.Progress = function (t) {
		var e = this.tween_list.
	default.progress / this.tween_list.
	default.duration;
		t.set_float(e)
	},
	n.Duration = function (t) {
		t.set_float(this.tween_list.
	default.duration)
	},
	n.Target = function (t) {
		var e = this.tween_list.
