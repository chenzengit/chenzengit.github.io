function CCreditsPanel(){
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oButLogo.y = CANVAS_HEIGHT/2 + 160;
        _oContainer.addChild(_oButLogo);

        _oLink = new createjs.Text(" ", "38px " + PRIMARY_FONT, "#ab152c");
        _oLink.textAlign = "center";
        _oLink.textBaseline = "alphabetic";
	_oLink.x = CANVAS_WIDTH/2;
        _oLink.y = CANVAS_HEIGHT/2 + 280;
    ...
    this._onLogoButRelease = function(){
        CreateLinksInGame('2048-Cuteness-Edition','pregame','logo');
    };
