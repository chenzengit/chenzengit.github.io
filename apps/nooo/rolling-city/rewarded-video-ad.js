(function(root) {
    var RewardedVideoAd = root.RewardedVideoAd = (function() {
        function RewardedVideoAd(videoId) {
        ...
        Object.assign(RewardedVideoAd.prototype, {
            load: function() {
                var self = this;
                ...
                var self = this;
                return new Promise(function(resolve, reject) {
                    function getRewardedVideoAsync(videoId) {
                        if (self.inited === true) {
                            ...
                            FBInstant.getRewardedVideoAsync(videoId).then(function(video) {
                                self.video = video;
                                self.inited = true;
                    ...
                    getRewardedVideoAsync(self.videoId).then(function(video) {
                        if (video === false) {
