...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        var updateSessionData = function () {
            FBInstant.player.getConnectedPlayersAsync().then(function (friends) {
                ...
                FBInstant.setSessionData({ friendList: friendList, locale: FBInstant.getLocale() });
            });
        };
        var updateMessengerStatic = function () {
            ...
            // if (data.mlist) {
            //     PlatformAPI.request({
            //         url: serverReportHttp + "/native/game/fb/cmessage.php",
            //         method: "POST",
            //         data: {
    ...
    startGameAsync(){
        return new Promise((resolve)=>{
            ...
            createVideoAd: function (id, callback) {
                ...
                window.__adErrorCallback = ()=>{
                    PlatformAPI.showToast("Video failed!")
                }
    ...
    }, { "SSSGameConfig": 3, "ToastAndModal": 4 }], 3: [function (require, module, exports) {
        "use strict";
        exports.__esModule = true;
        var initGame = function (__gameId) {
            ...
            window["initSSSGameConfig"] = function (_callback, onLoadFromNetDoneCallBack) {
                if (_callback === void 0) {
                    _callback = function () { console.log("initSSSGameConfig Done"); };
                }
                if (onLoadFromNetDoneCallBack === void 0) {
                    onLoadFromNetDoneCallBack = function () { console.log("onLoadFromNet Done"); };
                }
                if (isLoaded) {
