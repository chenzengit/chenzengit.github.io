...
var gradle = {
    ...
    enableBanner      : false, //Ads enable the banner. set to false to disable the banner.
    enableInterstitial: false, //Ads enable the interstitial. set to false to disable all interstitials.
