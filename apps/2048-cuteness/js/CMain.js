function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        if (navigator.userAgent.indexOf("Opera") > 0 || navigator.userAgent.indexOf("OPR") > 0) {
            ...
            createjs.Sound.registerSound("sounds/moving.ogg", "moving");
            createjs.Sound.registerSound("sounds/great_matching.ogg", "great_matching");
            ...
            createjs.Sound.registerSound("sounds/great_matching.mp3", "great_matching");
        }
